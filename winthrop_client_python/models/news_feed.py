...
class NewsFeed(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "body", "url", "source_id", "source_type", "links", "tags_list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": LinkCollection.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "tags_list": LinkCollection1.from_dict(obj["tags_list"]) if obj.get("tags_list") is not None else None
        })
        return _obj
