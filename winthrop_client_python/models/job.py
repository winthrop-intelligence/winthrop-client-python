...
class Job(BaseModel):
    ...
    candidates: Optional[List[JobCandidate]] = None
    __properties: ClassVar[List[str]] = ["id", "title", "description", "job_url", "posted_at", "created_at", "school", "departments", "sports", "candidates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "school": JobSchool.from_dict(obj["school"]) if obj.get("school") is not None else None,
            "departments": [JobDepartment.from_dict(_item) for _item in obj["departments"]] if obj.get("departments") is not None else None,
            "sports": [JobSport.from_dict(_item) for _item in obj["sports"]] if obj.get("sports") is not None else None,
            "candidates": [JobCandidate.from_dict(_item) for _item in obj["candidates"]] if obj.get("candidates") is not None else None
        })
        return _obj
