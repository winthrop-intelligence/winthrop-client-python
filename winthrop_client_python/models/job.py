...
class Job(BaseModel):
    ...
    expired: Optional[StrictBool] = Field(
        default=None,
        description="Raw posts.expired flag; matches what q[expired_eq] filters on and is not derived from expired_at.",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "candidates": (
                    [JobCandidate.from_dict(_item) for _item in obj["candidates"]]
