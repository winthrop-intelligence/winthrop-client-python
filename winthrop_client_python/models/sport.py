...
class Sport(BaseModel):
    ...
    visible: Optional[StrictBool] = Field(
        default=None,
        description="Operator-controlled customer-publication flag. When false, the Sport is hidden from ordinary customer credentials and only returned to superadmin/trusted service credentials.",
    )
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    ncaa_id: Optional[StrictStr] = None
