...
class GamePostEnrichmentScheduleIntentsInner(BaseModel):
    """
    ...
    game_types: Optional[List[StrictStr]] = Field(
        default=None,
        description='Deal-type designations for this availability day, as raw GameType *name* strings (e.g. "HomeAndHome"). Never includes "Pending".',
    )
