...
class UserCollection(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserCollection:
        """Create an instance of UserCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserCollection.parse_obj(obj)

        _obj = UserCollection.parse_obj(
            {
