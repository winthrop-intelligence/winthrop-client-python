...
class DepartmentGuaranteesFiledLine(BaseModel):
    """
    DepartmentGuaranteesFiledLine
    """  # noqa: E501

    year: StrictInt
    expense_cents: Optional[StrictInt]
    revenue_cents: Optional[StrictInt]
    __properties: ClassVar[List[str]] = ["year", "expense_cents", "revenue_cents"]
