...
class AuditedFinancialReportStatusCollection(BaseModel):
    """
    AuditedFinancialReportStatusCollection
    """

    data: Optional[conlist(AuditedFinancialReportStatus)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditedFinancialReportStatusCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuditedFinancialReportStatusCollection:
        """Create an instance of AuditedFinancialReportStatusCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditedFinancialReportStatusCollection.parse_obj(obj)

        _obj = AuditedFinancialReportStatusCollection.parse_obj(
            {
                "data": [
                    AuditedFinancialReportStatus.from_dict(_item)
