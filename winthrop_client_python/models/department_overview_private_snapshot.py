...
class DepartmentOverviewPrivateSnapshot(BaseModel):
    """
    ...
    year: StrictInt
    lines: List[DepartmentOverviewPrivateSnapshotLine]
    __properties: ClassVar[List[str]] = ["year", "lines"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "lines": (
                    [
                        DepartmentOverviewPrivateSnapshotLine.from_dict(_item)
