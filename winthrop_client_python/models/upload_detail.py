...
class UploadDetail(BaseModel):
    ...
    created_at: Optional[StrictStr] = Field(default=None, description="Pre-formatted date string in the user's timezone")
    has_file: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "filename", "uploaded_by", "created_at", "has_file"]
