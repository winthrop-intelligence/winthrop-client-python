...
class Compensation(BaseModel):
    ...
    coach_id: Optional[StrictInt] = Field(
        default=None,
        description="Required on creation. Existing coach-less records may return null. Updates may omit this field or send its unchanged value. To change an existing compensation's identity, move the linked position.",
    )
    ...
    year: Optional[StrictInt] = Field(
        default=None,
        description="Required on creation. Updates may omit this field or send its unchanged value. To change an existing compensation's identity, move the linked position.",
    )
