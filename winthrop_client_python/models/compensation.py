...
class Compensation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "bonus_comp_cents", "deferred_comp_cents", "talent_fee", "is_car_provided", "country_club_dues_cents", "coach_id", "buyout_terms", "executed_on", "expires_on", "start_on", "end_on", "average_yearly_comp_cents", "created_at", "updated_at", "outside_income_cents", "one_time_bonus_cents", "comment", "country_club_membership_paid", "base_salary_cents", "bonus_has_contingents", "calculated_guaranteed_comp_cents", "contingent_bonus", "noncontingent_bonus_comp_cents", "compensation_type", "media_link", "contract_status_id", "year", "school_id", "contract"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "calculated_guaranteed_comp_cents": obj.get("calculated_guaranteed_comp_cents"),
            "contingent_bonus": obj.get("contingent_bonus"),
            "noncontingent_bonus_comp_cents": obj.get("noncontingent_bonus_comp_cents"),
