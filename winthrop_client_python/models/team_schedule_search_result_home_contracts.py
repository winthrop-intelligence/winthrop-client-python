...
class TeamScheduleSearchResultHomeContracts(BaseModel):
    ...
    avg_paid_cents: Optional[StrictInt] = Field(
        default=None,
        description="Mean comp_cents of the school's last 10 signed Guarantee contracts as the home side, excluding zero/blank comp.",
    )
