...
class GetTimeZones200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "us_zones": [TimeZoneOption.from_dict(_item) for _item in obj["us_zones"]] if obj.get("us_zones") is not None else None,
            "other_zones": [TimeZoneOption.from_dict(_item) for _item in obj["other_zones"]] if obj.get("other_zones") is not None else None
        })
        return _obj
