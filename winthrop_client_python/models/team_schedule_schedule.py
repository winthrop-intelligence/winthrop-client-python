...
class TeamScheduleSchedule(BaseModel):
    """
    TeamScheduleSchedule
    """ # noqa: E501
    year: Optional[StrictInt] = None
    games: Optional[List[TeamScheduleScheduleGamesInner]] = None
    __properties: ClassVar[List[str]] = ["year", "games"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "year": obj.get("year"),
            "games": [TeamScheduleScheduleGamesInner.from_dict(_item) for _item in obj["games"]] if obj.get("games") is not None else None
        })
        return _obj
