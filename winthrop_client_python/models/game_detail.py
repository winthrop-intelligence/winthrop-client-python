...
class GameDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "home_school_id", "away_school_id", "sport_id", "game_date", "created_at", "updated_at", "neutral", "city", "game_contract_id", "state_id", "description", "in_conference", "season_year_tbd", "home_school_score", "away_school_score", "overtime", "season_year", "home_school_name", "away_school_name", "state_name", "game_contract"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "game_contract": GameDetailAllOfGameContract.from_dict(obj["game_contract"]) if obj.get("game_contract") is not None else None
        })
        return _obj
