...
class TeamScheduleCoachesCoachesInner(BaseModel):
    ...
    compensation: Optional[StrictStr] = Field(default=None, description="Compensation label (e.g. 'Hourly')")
    compensation_cents: Optional[StrictInt] = Field(default=None, description="Total compensation in cents")
    __properties: ClassVar[List[str]] = ["id", "name", "title", "email", "phone", "photo_url", "compensation", "compensation_cents"]
