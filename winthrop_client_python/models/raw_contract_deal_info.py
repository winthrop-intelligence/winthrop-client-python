...
class RawContractDealInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deal_id", "school_name", "school_id", "vendor_name", "vendors", "deal_type_name", "start_year", "end_year", "start_at", "end_at", "signed", "active", "archived", "autorenew", "summary", "term_years"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vendors": [ContactSearchCoachOptionsCoachesInner.from_dict(_item) for _item in obj["vendors"]] if obj.get("vendors") is not None else None,
