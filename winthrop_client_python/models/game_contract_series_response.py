...
class GameContractSeriesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "sport_name", "home_school_id", "home_school_name", "away_school_id", "away_school_name", "game_type", "season_year", "cancel_fee_cents", "raw_contract_id", "has_raw_contract", "can_download_raw_contract", "raw_contract_url", "raw_contract_filename", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GameContractSeriesEntry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
