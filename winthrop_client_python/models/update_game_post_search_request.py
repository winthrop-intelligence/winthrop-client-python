...
class UpdateGamePostSearchRequest(BaseModel):
    """
    UpdateGamePostSearchRequest
    """  # noqa: E501

    game_post: Optional[UpdateGamePostSearchRequestGamePost] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "game_post": (
                    UpdateGamePostSearchRequestGamePost.from_dict(obj["game_post"])
