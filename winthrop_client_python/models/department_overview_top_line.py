...
class DepartmentOverviewTopLine(BaseModel):
    """
    ...
    share: Optional[float] = Field(description="Percentage of the ledger total")
    __properties: ClassVar[List[str]] = ["key", "label", "amount_cents", "share"]
