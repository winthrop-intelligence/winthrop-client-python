...
class AthleticProfileShowSportFinancialsProgramCostPerWin(BaseModel):
    """
    ...
    fiscal_year: Optional[StrictInt] = Field(
        default=None,
        description="The EADA filing year the expense and margin come from.",
    )
    expense_cents: Optional[StrictInt] = None
    wins: Optional[StrictInt] = None
    per_win_cents: Optional[StrictInt] = None
    margin_cents: Optional[StrictInt] = Field(
        default=None,
        description="EADA revenue minus expense; null when the filing priced only one of them.",
    )
    cohort_median_per_win_cents: Optional[StrictInt] = None
    cohort_size: Optional[StrictInt] = None
    cheapest: Optional[AthleticProfileShowSportFinancialsProgramCostPerWinCheapest] = (
        None
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if margin_cents (nullable) is None
        # and model_fields_set contains the field
        if self.margin_cents is None and "margin_cents" in self.model_fields_set:
            _dict["margin_cents"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "margin_cents": obj.get("margin_cents"),
                "cohort_median_per_win_cents": obj.get("cohort_median_per_win_cents"),
                "cohort_size": obj.get("cohort_size"),
                "cheapest": (
                    AthleticProfileShowSportFinancialsProgramCostPerWinCheapest.from_dict(
                        obj["cheapest"]
                    )
