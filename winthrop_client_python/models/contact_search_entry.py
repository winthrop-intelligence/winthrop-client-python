...
class ContactSearchEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "school_id", "coach_id", "sport_id", "coach_name", "sport_name_display", "created_at", "updated_at"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.sport_name_display is None and "sport_name_display" in self.model_fields_set:
