...
class GameCollection(BaseModel):
    ...
    data: Optional[conlist(Game)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GameCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GameCollection:
        """Create an instance of GameCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GameCollection.parse_obj(obj)

        _obj = GameCollection.parse_obj(
            {
                "data": [Game.from_dict(_item) for _item in obj.get("data")]
