...
class InvoiceReportRow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "invoice_date", "due_date", "payment_received", "status", "amount_dollars", "notes", "account"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "account": InvoiceReportAccount.from_dict(obj["account"]) if obj.get("account") is not None else None
        })
        return _obj
