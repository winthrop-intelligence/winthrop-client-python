...
class SchoolGameContractsResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "school": SchoolGameContractsResponseSchool.from_dict(obj["school"]) if obj.get("school") is not None else None,
            "sports": [SchoolSportSection.from_dict(_item) for _item in obj["sports"]] if obj.get("sports") is not None else None
        })
        return _obj
