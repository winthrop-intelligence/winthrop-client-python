...
class UpdateAccountUserActivationRequest(BaseModel):
    ...
    """ # noqa: E501
    confirmation_token: StrictStr = Field(description="The confirmation token from the invitation email")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user": UpdateAccountUserActivationRequestUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
