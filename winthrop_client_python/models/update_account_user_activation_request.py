...
class UpdateAccountUserActivationRequest(BaseModel):
    """
    UpdateAccountUserActivationRequest
    """  # noqa: E501

    confirmation_token: StrictStr = Field(
        description="The confirmation token from the invitation email"
    )
    user: UpdateAccountUserActivationRequestUser
    __properties: ClassVar[List[str]] = ["confirmation_token", "user"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "user": (
                    UpdateAccountUserActivationRequestUser.from_dict(obj["user"])
