...
class Position(BaseModel):
    ...
    suppress_departing_set_at: Optional[StrictBool] = Field(
        default=None,
        description="Write-only control flag for trusted automation. When true and departing is set to true, WinAD does not stamp departing_set_at, so historical/catch-up departures are not published as current wire events. Ignored on responses.",
    )
