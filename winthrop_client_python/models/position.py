...
class Position(BaseModel):
    ...
    def creation_reason_validate_enum(cls, value):
        ...
        if value not in set(['renewed', 'new_hire', 'promotion', 'extension']):
            raise ValueError("must be one of enum values ('renewed', 'new_hire', 'promotion', 'extension')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sport": Sport.from_dict(obj["sport"]) if obj.get("sport") is not None else None,
