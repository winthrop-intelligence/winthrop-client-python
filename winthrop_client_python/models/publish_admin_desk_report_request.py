...
class PublishAdminDeskReportRequest(BaseModel):
    ...
    note: Optional[StrictStr] = Field(
        default=None, description="The version's 06.5 history line"
    )
    renotify: Optional[StrictBool] = Field(
        default=None,
        description="06.5's re-notify box — re-send the delivery email for a new version",
    )
    __properties: ClassVar[List[str]] = ["body_html", "note", "renotify"]
