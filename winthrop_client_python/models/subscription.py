...
class Subscription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "accountable_id", "creator_id", "start_at", "end_at", "amount_cents", "created_at", "updated_at", "subscription_type_id", "autorenew", "activity_cache_id", "old_email_domain", "account_id", "contract_term", "raw_contract_id", "slug", "contract_accepted", "active", "contract_accepted_ip_address", "renewal", "renewing", "invoicing", "notes", "send_renewal", "standard_agreement", "active_users_count", "has_intercollegiate_access"]
