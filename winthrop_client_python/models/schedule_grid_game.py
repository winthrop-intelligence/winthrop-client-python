...
class ScheduleGridGame(BaseModel):
    ...
    created_by_school_id: Optional[StrictInt] = Field(
        default=None,
        description="School account ID that created this game when entered by a school account; null for internal/admin/support or unknown sources",
    )
    school_entered: Optional[StrictBool] = Field(
        default=None,
        description="True when this game was entered by a user from the school account represented by this grid column",
    )
