...
class JobPostCollection(BaseModel):
    ...
    data: Optional[conlist(JobPost)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JobPostCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JobPostCollection:
        """Create an instance of JobPostCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JobPostCollection.parse_obj(obj)

        _obj = JobPostCollection.parse_obj(
            {
                "data": [JobPost.from_dict(_item) for _item in obj.get("data")]
