...
class AthleticProfileShowGamesInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "opponent_name", "opponent_id", "is_away", "game_date", "season_year_tbd", "city", "state_name", "rpi", "net_rank", "compensation_cents", "game_contract_id"]
