...
class JobPostInterestLeadCollection(BaseModel):
    """
    JobPostInterestLeadCollection
    """  # noqa: E501

    data: Optional[List[JobPostInterestLead]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": (
                    [JobPostInterestLead.from_dict(_item) for _item in obj["data"]]
                    if obj.get("data") is not None
                    else None
                ),
                "meta": (
                    Meta1.from_dict(obj["meta"])
