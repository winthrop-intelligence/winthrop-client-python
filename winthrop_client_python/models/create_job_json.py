...
class CreateJobJson(BaseModel):
    ...
    source: JobSource
    profile: Optional[StrictStr] = "default"
    options: Optional[JobOptions] = None
    __properties: ClassVar[List[str]] = ["source", "profile", "options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "source": (
                    JobSource.from_dict(obj["source"])
                    if obj.get("source") is not None
                    else None
                ),
                "profile": (
                    obj.get("profile") if obj.get("profile") is not None else "default"
                ),
                "options": (
                    JobOptions.from_dict(obj["options"])
