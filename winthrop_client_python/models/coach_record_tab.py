...
class CoachRecordTab(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["leader_ad", "show_coach_apr", "positions", "conference_positions", "performance_chart"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "positions": [RecordPositionEntry.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None,
            "conference_positions": [ConferencePositionEntry.from_dict(_item) for _item in obj["conference_positions"]] if obj.get("conference_positions") is not None else None,
            "performance_chart": PerformanceChartData.from_dict(obj["performance_chart"]) if obj.get("performance_chart") is not None else None
        })
        return _obj
