...
class CoachCompensation(BaseModel):
    ...
    salary: Optional[float] = Field(default=None, description="The base salary (rounded to 2 decimal places)")
    year: Optional[StrictInt] = None
    coli_salary: Optional[float] = None
    __properties: ClassVar[List[str]] = ["coach_id", "estimated", "salary", "year", "coli_salary"]
