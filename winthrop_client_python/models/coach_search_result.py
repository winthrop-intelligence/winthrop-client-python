...
class CoachSearchResult(BaseModel):
    ...
    compensation_cents: Optional[StrictInt] = Field(default=None, description="Total compensation in cents (included based on authorization)")
    base_salary_cents: Optional[StrictInt] = Field(default=None, description="Base salary in cents (included based on authorization)")
    coli: Optional[float] = Field(default=None, description="School's cost-of-living index (included based on authorization)")
    compensation_type: Optional[StrictStr] = Field(default=None, description="Compensation type (included based on authorization)")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.school_short_name is None and "school_short_name" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.coach_friendly_id is None and "coach_friendly_id" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.season_conference_position is None and "season_conference_position" in self.model_fields_set:
            _dict['season_conference_position'] = None

        # set to None if season_conference_num_positions (nullable) is None
        # and model_fields_set contains the field
        if self.season_conference_num_positions is None and "season_conference_num_positions" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.compensation_cents is None and "compensation_cents" in self.model_fields_set:
            _dict['compensation_cents'] = None

        # set to None if base_salary_cents (nullable) is None
        # and model_fields_set contains the field
        if self.base_salary_cents is None and "base_salary_cents" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.compensation_type is None and "compensation_type" in self.model_fields_set:
            _dict['compensation_type'] = None

        # set to None if compensation_contingent_bonus (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_contingent_bonus is None and "compensation_contingent_bonus" in self.model_fields_set:
            _dict['compensation_contingent_bonus'] = None

        # set to None if compensation_deferred_comp_cents (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_deferred_comp_cents is None and "compensation_deferred_comp_cents" in self.model_fields_set:
            _dict['compensation_deferred_comp_cents'] = None

        # set to None if compensation_one_time_bonus_cents (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_one_time_bonus_cents is None and "compensation_one_time_bonus_cents" in self.model_fields_set:
            _dict['compensation_one_time_bonus_cents'] = None

        # set to None if compensation_buyout_terms (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_buyout_terms is None and "compensation_buyout_terms" in self.model_fields_set:
            _dict['compensation_buyout_terms'] = None

        # set to None if compensation_is_car_provided (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_is_car_provided is None and "compensation_is_car_provided" in self.model_fields_set:
            _dict['compensation_is_car_provided'] = None

        # set to None if compensation_outside_income_cents (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_outside_income_cents is None and "compensation_outside_income_cents" in self.model_fields_set:
            _dict['compensation_outside_income_cents'] = None

        # set to None if compensation_talent_fee (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_talent_fee is None and "compensation_talent_fee" in self.model_fields_set:
            _dict['compensation_talent_fee'] = None

        # set to None if compensation_county_club_membership_paid (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_county_club_membership_paid is None and "compensation_county_club_membership_paid" in self.model_fields_set:
            _dict['compensation_county_club_membership_paid'] = None

        # set to None if compensation_media_link (nullable) is None
        # and model_fields_set contains the field
        if self.compensation_media_link is None and "compensation_media_link" in self.model_fields_set:
            _dict['compensation_media_link'] = None

        # set to None if contract_starts_on (nullable) is None
        # and model_fields_set contains the field
        if self.contract_starts_on is None and "contract_starts_on" in self.model_fields_set:
            _dict['contract_starts_on'] = None

        # set to None if contract_expires_on (nullable) is None
        # and model_fields_set contains the field
        if self.contract_expires_on is None and "contract_expires_on" in self.model_fields_set:
            _dict['contract_expires_on'] = None

        # set to None if contract_at_will (nullable) is None
        # and model_fields_set contains the field
        if self.contract_at_will is None and "contract_at_will" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "season_conference_num_positions": obj.get("season_conference_num_positions"),
            "rpi": obj.get("rpi"),
            ...
            "compensation_county_club_membership_paid": obj.get("compensation_county_club_membership_paid"),
