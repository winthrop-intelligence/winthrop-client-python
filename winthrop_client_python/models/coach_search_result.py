...
class CoachSearchResult(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of newer_season
        if self.newer_season:
            _dict["newer_season"] = self.newer_season.to_dict()
        ...
        # set to None if newer_season (nullable) is None
        # and model_fields_set contains the field
        if self.newer_season is None and "newer_season" in self.model_fields_set:
            _dict["newer_season"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "year": obj.get("year"),
                "newer_season": (
                    NewerSeasonContext.from_dict(obj["newer_season"])
                    if obj.get("newer_season") is not None
                    else None
                ),
