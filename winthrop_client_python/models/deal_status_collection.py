...
class DealStatusCollection(BaseModel):
    """
    DealStatusCollection
    """

    data: Optional[conlist(DealStatus)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DealStatusCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DealStatusCollection:
        """Create an instance of DealStatusCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DealStatusCollection.parse_obj(obj)

        _obj = DealStatusCollection.parse_obj(
            {
                "data": [DealStatus.from_dict(_item) for _item in obj.get("data")]
