...
class ConferenceCashflowStatsResponse(BaseModel):
    """
    ConferenceCashflowStatsResponse
    """  # noqa: E501

    year: Optional[StrictInt] = None
    groups: Optional[List[CashflowGroupStats]] = None
    __properties: ClassVar[List[str]] = ["year", "groups"]
        ...
        _obj = cls.model_validate(
            {
                "year": obj.get("year"),
                "groups": (
                    [CashflowGroupStats.from_dict(_item) for _item in obj["groups"]]
