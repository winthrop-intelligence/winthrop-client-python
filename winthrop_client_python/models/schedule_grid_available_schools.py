...
class ScheduleGridAvailableSchools(BaseModel):
    ...
    """ # noqa: E501
    available_count: Optional[StrictInt] = Field(default=None, description="Total matching schools before the limit is applied")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schools": [ScheduleGridAvailableSchoolRow.from_dict(_item) for _item in obj["schools"]] if obj.get("schools") is not None else None
        })
        return _obj
