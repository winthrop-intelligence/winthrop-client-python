...
class ConferencePositionEntry(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["year_str", "school_name", "school_id", "sport", "position", "record", "conference_record", "postseason"]
