...
class DepartmentCoachesResultWindow(BaseModel):
    """
    ...
    end_year: StrictInt
    __properties: ClassVar[List[str]] = ["start_year", "end_year"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"start_year": obj.get("start_year"), "end_year": obj.get("end_year")}
        )
        return _obj
