...
class CoachCompensationTabComparisons(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conference": ComparisonSection.from_dict(obj["conference"]) if obj.get("conference") is not None else None,
            "division": ComparisonSection.from_dict(obj["division"]) if obj.get("division") is not None else None
        })
        return _obj
