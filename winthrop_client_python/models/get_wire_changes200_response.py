...
class GetWireChanges200Response(BaseModel):
    """
    GetWireChanges200Response
    """  # noqa: E501

    meta: Optional[Meta] = None
    wire_changes: Optional[List[WireChange]] = None
    __properties: ClassVar[List[str]] = ["meta", "wire_changes"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "wire_changes": (
                    [WireChange.from_dict(_item) for _item in obj["wire_changes"]]
                    if obj.get("wire_changes") is not None
                    else None
                ),
            }
        )
