...
class AsstCoachSchool(BaseModel):
    """
    AsstCoachSchool
    """ # noqa: E501
    school_id: Optional[StrictInt] = None
    school_name: Optional[StrictStr] = None
    pool_total: Optional[StrictInt] = None
    coaches: Optional[List[AsstCoachEntry]] = None
    __properties: ClassVar[List[str]] = ["school_id", "school_name", "pool_total", "coaches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pool_total": obj.get("pool_total"),
            "coaches": [AsstCoachEntry.from_dict(_item) for _item in obj["coaches"]] if obj.get("coaches") is not None else None
        })
        return _obj
