...
class DepartmentSearchResultDepartment(BaseModel):
    ...
    ad_status: Optional[StrictStr] = None
    ...
    def ad_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(["filled", "interim", "vacant"]):
            raise ValueError(
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.budget_rank is None and "budget_rank" in self.model_fields_set:
            _dict["budget_rank"] = None

        # set to None if budget_rank_of (nullable) is None
        # and model_fields_set contains the field
        if self.budget_rank_of is None and "budget_rank_of" in self.model_fields_set:
            _dict["budget_rank_of"] = None

        # set to None if budget_rank_conference_name (nullable) is None
        # and model_fields_set contains the field
        if (
            self.budget_rank_conference_name is None
            and "budget_rank_conference_name" in self.model_fields_set
        ):
            _dict["budget_rank_conference_name"] = None
