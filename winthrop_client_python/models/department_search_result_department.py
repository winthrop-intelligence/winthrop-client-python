...
class DepartmentSearchResultDepartment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ad_name", "ad_coach_id", "ad_salary_cents", "revenue_cents", "expense_cents", "deals"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deals": [DepartmentSearchResultDepartmentDealsInner.from_dict(_item) for _item in obj["deals"]] if obj.get("deals") is not None else None
        })
        return _obj
