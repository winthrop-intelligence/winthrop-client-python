...
class ScheduleGridAvailableSchoolPost(BaseModel):
    ...
    primary_deal_type: Optional[StrictStr] = Field(default=None, description="First matching deal type in priority order (HomeAndHome, GuaranteeOffered, GuaranteeNeeded, Tournament, Neutral)")
    __properties: ClassVar[List[str]] = ["id", "start_date", "end_date", "game_types", "primary_deal_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.primary_deal_type is None and "primary_deal_type" in self.model_fields_set:
