...
class GamePostSearchResultCollection(BaseModel):
    ...
    active_posts_total: Optional[StrictInt] = Field(
        default=None,
        description='WINAD-9909: raw count of active posts matching the filters (the "N active posts" headline). Cards are grouped one per school, so meta.total_entries counts schools, not posts.',
    )
