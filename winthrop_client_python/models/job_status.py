...
class JobStatus(BaseModel):
    ...
    uploaded_file_id: Optional[StrictStr] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if uploaded_file_id (nullable) is None
        # and model_fields_set contains the field
        if (
            self.uploaded_file_id is None
            and "uploaded_file_id" in self.model_fields_set
        ):
            _dict["uploaded_file_id"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "uploaded_file_id": obj.get("uploaded_file_id"),
                "error": obj.get("error"),
            }
        )
        return _obj
