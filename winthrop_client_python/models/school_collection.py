...
class SchoolCollection(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SchoolCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SchoolCollection:
        """Create an instance of SchoolCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SchoolCollection.parse_obj(obj)

        _obj = SchoolCollection.parse_obj(
            {
