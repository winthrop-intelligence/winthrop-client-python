...
class BulkCreateGamesRequestGamesInner(BaseModel):
    """
    BulkCreateGamesRequestGamesInner
    """ # noqa: E501
    home_school_id: StrictInt
    away_school_id: StrictInt
    sport_id: StrictInt
    game_date: Optional[date] = None
    neutral: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["home_school_id", "away_school_id", "sport_id", "game_date", "neutral"]
