...
class TeamScheduleCoaches(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["performance_year", "performance_years", "sport_name", "coaches", "head_coaches", "seasons"]
        ...
        if self.head_coaches:
            for _item_head_coaches in self.head_coaches:
                if _item_head_coaches:
                    _items.append(
                         [_inner_item.to_dict() for _inner_item in _item_head_coaches if _inner_item is not None]
                    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "coaches": [TeamScheduleCoachesCoachesInner.from_dict(_item) for _item in obj["coaches"]] if obj.get("coaches") is not None else None,
            "head_coaches": [
                    [TeamScheduleCoachesHeadCoachesInnerInner.from_dict(_inner_item) for _inner_item in _item]
                    for _item in obj["head_coaches"]
                ] if obj.get("head_coaches") is not None else None,
            "seasons": [TeamScheduleCoachesSeasonsInner.from_dict(_item) for _item in obj["seasons"]] if obj.get("seasons") is not None else None
        })
        return _obj
