...
class TeamScheduleSearchResultAwayContracts(BaseModel):
    ...
    """ # noqa: E501
    avg_received_cents: Optional[StrictInt] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.avg_received_cents is None and "avg_received_cents" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recent": [TeamScheduleRecentContract.from_dict(_item) for _item in obj["recent"]] if obj.get("recent") is not None else None
        })
        return _obj
