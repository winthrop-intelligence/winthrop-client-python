...
class TeamSchedulePlayerDataTransfersInner(BaseModel):
    """
    ...
    eligible: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "position", "height", "weight", "eligible"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if eligible (nullable) is None
        # and model_fields_set contains the field
        if self.eligible is None and "eligible" in self.model_fields_set:
            _dict['eligible'] = None
