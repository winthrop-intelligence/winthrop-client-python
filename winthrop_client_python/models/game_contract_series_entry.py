...
class GameContractSeriesEntry(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "sport_name", "home_school_id", "home_school_name", "away_school_id", "away_school_name", "comp_cents", "comp_tbd", "variable", "cancel_fee_cents", "cancelled", "season_year", "game_date", "game_date_tbd"]
