...
class DepartmentFinancialsEadaLedger(BaseModel):
    """
    ...
    year: StrictInt
    basis: StrictStr
    comparable_with_frs: StrictBool
    lines: List[DepartmentFinancialsEadaLedgerLine]
        ...
        _obj = cls.model_validate(
            {
                ...
                "lines": (
                    [
                        DepartmentFinancialsEadaLedgerLine.from_dict(_item)
                        for _item in obj["lines"]
                    ]
