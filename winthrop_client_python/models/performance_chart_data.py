...
class PerformanceChartData(BaseModel):
    ...
    """ # noqa: E501
    seasons: List[StrictStr]
    records: List[PerformanceChartRecord]
    coaches: List[PerformanceChartCoach]
    __properties: ClassVar[List[str]] = ["seasons", "records", "coaches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [PerformanceChartRecord.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None,
            "coaches": [PerformanceChartCoach.from_dict(_item) for _item in obj["coaches"]] if obj.get("coaches") is not None else None
        })
        return _obj
