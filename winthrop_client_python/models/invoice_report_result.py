...
class InvoiceReportResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["current_page", "total_pages", "total_entries", "next_page", "previous_page", "invoices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoices": [InvoiceReportRow.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None
        })
        return _obj
