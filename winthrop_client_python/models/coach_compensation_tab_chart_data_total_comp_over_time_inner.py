...
class CoachCompensationTabChartDataTotalCompOverTimeInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["year", "comp_cents", "position", "base_salary_cents", "bonus_cents", "deferred_comp_cents"]
