...
class SystemSetting(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "current_season_year", "current_financials_season_year", "schedule_season_year", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current_financials_season_year": obj.get("current_financials_season_year"),
