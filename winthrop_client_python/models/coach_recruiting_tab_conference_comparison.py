...
class CoachRecruitingTabConferenceComparison(BaseModel):
    """
    CoachRecruitingTabConferenceComparison
    """ # noqa: E501
    title: StrictStr
    entries: List[RecruitingConferenceEntry]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "title": obj.get("title"),
            "entries": [RecruitingConferenceEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
