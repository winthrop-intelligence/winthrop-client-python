...
class TeamScheduleContact(BaseModel):
    ...
    mobile_phone: Optional[StrictStr] = Field(
        default=None, description="Formatted mobile/cell phone number"
    )
    scheduling_phone: Optional[StrictStr] = Field(
        default=None,
        description="User-controlled scheduling phone (textable); null when unset",
    )
