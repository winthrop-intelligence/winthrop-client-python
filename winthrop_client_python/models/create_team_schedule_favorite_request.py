...
class CreateTeamScheduleFavoriteRequest(BaseModel):
    ...
    """ # noqa: E501
    favoritable_id: StrictStr = Field(description="The FilTeam ID (as string to preserve precision)")
    favorites_category_id: Optional[StrictInt] = Field(default=None, description="Optional category to assign the favorite to")
