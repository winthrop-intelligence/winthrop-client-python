...
class ScheduleGridScheduleTournament(BaseModel):
    """
    ...
    var_date: Optional[date] = Field(
        default=None,
        description="The single cell date this tournament applies to",
        alias="date",
    )
    ...
    __properties: ClassVar[List[str]] = ["id", "date", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "date": obj.get("date"), "name": obj.get("name")}
        )
        return _obj
