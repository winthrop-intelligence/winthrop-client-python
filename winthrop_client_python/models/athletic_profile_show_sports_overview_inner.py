...
class AthleticProfileShowSportsOverviewInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sport_name", "sport_key", "conference_name", "head_coach_name", "head_coach_id", "record", "apr", "rpi", "net_rank", "head_coach_comp_cents", "asst_pool_cents"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.head_coach_comp_cents is None and "head_coach_comp_cents" in self.model_fields_set:
