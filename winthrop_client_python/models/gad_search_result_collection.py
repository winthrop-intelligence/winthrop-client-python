...
class GadSearchResultCollection(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "meta", "stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [GadSearchResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "meta": Meta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "stats": GadSearchStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None
        })
        return _obj
