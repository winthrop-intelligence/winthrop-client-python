...
class AvailableGameContract(BaseModel):
    ...
    game_type: Optional[StrictStr] = Field(default=None, description="One of Guarantee, Neutral, Tournament, Exhibition.")
    comp_cents: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "sport_name", "home_school_name", "away_school_name", "game_date", "game_date_tbd", "game_type", "comp_cents"]
