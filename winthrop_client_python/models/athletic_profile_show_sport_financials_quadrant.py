...
class AthleticProfileShowSportFinancialsQuadrant(BaseModel):
    """
    AthleticProfileShowSportFinancialsQuadrant
    """  # noqa: E501

    fiscal_year: Optional[StrictInt] = None
    points: Optional[List[AthleticProfileShowSportFinancialsQuadrantPointsInner]] = None
    unplotted: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["fiscal_year", "points", "unplotted"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "points": (
                    [
                        AthleticProfileShowSportFinancialsQuadrantPointsInner.from_dict(
                            _item
                        )
