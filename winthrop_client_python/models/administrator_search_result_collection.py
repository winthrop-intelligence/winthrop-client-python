...
class AdministratorSearchResultCollection(BaseModel):
    ...
    comp_stats: Optional[CompStats] = Field(
        default=None,
        description="Compensation statistics for the full filtered result set (before pagination). Only included when the user has administrator_compensation permission.",
    )
