...
class Coach(BaseModel):
    ...
    visible: Optional[StrictBool] = Field(
        default=None,
        description="Whether the coach appears on customer-facing surfaces. Also clears the Coach-level FOIA gate; FOIA eligibility additionally requires a current position with a requestable PositionType outside the Hidden Coaches group.",
    )
