...
class Coach(BaseModel):
    ...
    alma_mater_id: Optional[StrictInt] = Field(default=None, description="ID of School, You can view Alma Mater using School API")
    ...
    latest_salary: Optional[StrictInt] = Field(default=None, description="Only included when the user has coach_compensation permission for this coach. For leader/administrator coaches, this requires administrator_compensation access.")
    latest_salary_year: Optional[StrictInt] = Field(default=None, description="Only included when the user has coach_compensation permission for this coach. For leader/administrator coaches, this requires administrator_compensation access.")
