...
class ScheduleGridAvailableSchoolRow(BaseModel):
    ...
    torvik_rank: Optional[StrictInt] = Field(
        default=None,
        description="Recent average Torvik (T-Rank) for basketball schools, shown as a secondary quality signal alongside NET (omitted when blank or non-basketball)",
    )
