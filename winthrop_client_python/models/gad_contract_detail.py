...
class GadContractDetail(BaseModel):
    ...
    can_download_raw_contract: Optional[StrictBool] = None
    can_see_admin_view: Optional[StrictBool] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.home_school_name is None and "home_school_name" in self.model_fields_set:
            _dict['home_school_name'] = None

        # set to None if home_school_short_name (nullable) is None
        # and model_fields_set contains the field
        if self.home_school_short_name is None and "home_school_short_name" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.away_school_name is None and "away_school_name" in self.model_fields_set:
            _dict['away_school_name'] = None

        # set to None if away_school_short_name (nullable) is None
        # and model_fields_set contains the field
        if self.away_school_short_name is None and "away_school_short_name" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.cancel_fee_cents is None and "cancel_fee_cents" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.off_site_location is None and "off_site_location" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.raw_contract_url is None and "raw_contract_url" in self.model_fields_set:
            _dict['raw_contract_url'] = None

        # set to None if raw_contract_filename (nullable) is None
        # and model_fields_set contains the field
        if self.raw_contract_filename is None and "raw_contract_filename" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.unstract_text_state is None and "unstract_text_state" in self.model_fields_set:
            _dict['unstract_text_state'] = None

        # set to None if unstract_layout_state (nullable) is None
        # and model_fields_set contains the field
        if self.unstract_layout_state is None and "unstract_layout_state" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.layout_preserved_text is None and "layout_preserved_text" in self.model_fields_set:
            _dict['layout_preserved_text'] = None

        # set to None if unstract_text_error (nullable) is None
        # and model_fields_set contains the field
        if self.unstract_text_error is None and "unstract_text_error" in self.model_fields_set:
            _dict['unstract_text_error'] = None

        # set to None if unstract_layout_error (nullable) is None
        # and model_fields_set contains the field
        if self.unstract_layout_error is None and "unstract_layout_error" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "can_download_raw_contract": obj.get("can_download_raw_contract"),
