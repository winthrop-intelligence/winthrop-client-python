...
class BulkCreateGamesRequest(BaseModel):
    """
    BulkCreateGamesRequest
    """ # noqa: E501
    games: Annotated[List[BulkCreateGamesRequestGamesInner], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["games"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "games": [BulkCreateGamesRequestGamesInner.from_dict(_item) for _item in obj["games"]] if obj.get("games") is not None else None
        })
        return _obj
