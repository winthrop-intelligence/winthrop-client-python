...
class School(BaseModel):
    ...
    rank: Optional[StrictInt] = Field(
        default=None,
        description="Latest sport-appropriate ranking (NET for basketball, AP for football, RPI otherwise). Included only when the index is queried with `sport_name`; when included, the value is null for a school with no ranked season for that sport.",
    )
