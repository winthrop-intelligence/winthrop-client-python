...
class School(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "short_name", "location", "created_at", "updated_at", "city", "nickname", "external_url", "colors", "state", "primary_conference_id", "cost_of_living_index_city_code", "current_directors_cup_ranking", "current_usnwr_ranking", "private", "school_classification_id", "logo_updated_at", "youtube_search_name", "latitude", "longitude", "address_1", "address_2", "zip_code", "logo_image", "athletic_director", "athletics_url", "wikipedia_url", "athletics_wikipedia_url", "external_logo_image", "school_status", "athletics_instagram_handle", "athletics_twitter_handle", "external_instagram_handle", "external_twitter_handle", "ncaa_id", "conference", "division", "subdivisions"]
    ...
    def school_status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'closed', 'international']):
            raise ValueError("must be one of enum values ('active', 'closed', 'international')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cost_of_living_index_city_code": obj.get("cost_of_living_index_city_code"),
            "current_directors_cup_ranking": obj.get("current_directors_cup_ranking"),
            ...
            "logo_image": Logo.from_dict(obj["logo_image"]) if obj.get("logo_image") is not None else None,
            "athletic_director": Coach.from_dict(obj["athletic_director"]) if obj.get("athletic_director") is not None else None,
            ...
            "external_logo_image": Logo.from_dict(obj["external_logo_image"]) if obj.get("external_logo_image") is not None else None,
            ...
            "conference": Conference.from_dict(obj["conference"]) if obj.get("conference") is not None else None,
            "division": Division.from_dict(obj["division"]) if obj.get("division") is not None else None,
            "subdivisions": [Subdivision.from_dict(_item) for _item in obj["subdivisions"]] if obj.get("subdivisions") is not None else None
        })
        return _obj
