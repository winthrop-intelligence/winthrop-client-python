...
class School(BaseModel):
    ...
    rank: Optional[StrictInt] = Field(
        default=None,
        description="Latest sport-appropriate ranking (NET/AP/RPI). Only present when the schools index is queried with a sport_name; null when the school has no ranked season for that sport.",
    )
