...
class CashflowSportStat(BaseModel):
    ...
    entries: Optional[List[CashflowEntry]] = None
    __properties: ClassVar[List[str]] = ["sport_id", "sport_name", "gender_code", "high", "low", "median", "count", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "entries": [CashflowEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
