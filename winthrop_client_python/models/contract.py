...
class Contract(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "executed_on", "expires_on", "start_on", "end_on", "at_will", "verified", "contractable_type", "contractable_id", "raw_contract_id", "created_at", "updated_at"]
