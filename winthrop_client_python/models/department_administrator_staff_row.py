...
class DepartmentAdministratorStaffRow(BaseModel):
    """
    ...
    last_name: Optional[StrictStr] = Field(
        description="Canonical surname from the roster record — display labels must not re-parse the full name"
    )
    title: Optional[StrictStr]
    departments: List[StrictStr]
    is_ad: StrictBool
    comp_cents: Optional[StrictInt] = Field(
        description="Null in private mode and for viewers without the administrator_compensation ability"
    )
