...
class UpdateScheduleIntentRequestScheduleIntent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["game_type_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"game_type_ids": obj.get("game_type_ids")})
        return _obj
