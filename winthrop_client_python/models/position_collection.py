...
class PositionCollection(BaseModel):
    ...
    data: Optional[conlist(Position)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PositionCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PositionCollection:
        """Create an instance of PositionCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PositionCollection.parse_obj(obj)

        _obj = PositionCollection.parse_obj(
            {
                "data": [Position.from_dict(_item) for _item in obj.get("data")]
