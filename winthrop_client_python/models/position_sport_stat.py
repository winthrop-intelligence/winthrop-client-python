...
class PositionSportStat(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.high_position_num is None
            and "high_position_num" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.low_position_num is None
            and "low_position_num" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.median_position_num is None
            and "median_position_num" in self.model_fields_set
        ):
