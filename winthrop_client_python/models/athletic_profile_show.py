...
class AthleticProfileShow(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sport_overview
        if self.sport_overview:
            _dict["sport_overview"] = self.sport_overview.to_dict()
        # override the default output from pydantic by calling `to_dict()` of sport_coach_staff
        if self.sport_coach_staff:
            _dict["sport_coach_staff"] = self.sport_coach_staff.to_dict()
        ...
        # set to None if sport_overview (nullable) is None
        # and model_fields_set contains the field
        if self.sport_overview is None and "sport_overview" in self.model_fields_set:
            _dict["sport_overview"] = None

        # set to None if sport_coach_staff (nullable) is None
        # and model_fields_set contains the field
        if (
            self.sport_coach_staff is None
            and "sport_coach_staff" in self.model_fields_set
        ):
            _dict["sport_coach_staff"] = None

        # set to None if sport_financials (nullable) is None
        # and model_fields_set contains the field
        if (
            self.sport_financials is None
        ...
        _obj = cls.model_validate(
            {
                ...
                "sport_overview": (
                    AthleticProfileShowSportOverview.from_dict(obj["sport_overview"])
                    if obj.get("sport_overview") is not None
                    else None
                ),
                "sport_coach_staff": (
                    AthleticProfileShowSportCoachStaff.from_dict(
                        obj["sport_coach_staff"]
                    )
                    if obj.get("sport_coach_staff") is not None
                    else None
                ),
                "sport_financials": (
                    AthleticProfileShowSportFinancials.from_dict(
