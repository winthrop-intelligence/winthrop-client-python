...
class DealSearchResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "deal_id", "school_id", "school_name", "conference_name", "conference_id", "division_id", "deal_type_name", "deal_type_id", "vendor_names", "start_year", "end_year", "start_at", "end_at", "created_at", "summary", "autorenew", "archived", "vendors", "deal_detail", "raw_contract_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vendors": [DealDetailVendor.from_dict(_item) for _item in obj["vendors"]] if obj.get("vendors") is not None else None,
            "deal_detail": DealDetail.from_dict(obj["deal_detail"]) if obj.get("deal_detail") is not None else None,
