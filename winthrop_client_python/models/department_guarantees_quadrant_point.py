...
class DepartmentGuaranteesQuadrantPoint(BaseModel):
    """
    ...
    paid_cents: StrictInt
    received_cents: StrictInt
        ...
        _obj = cls.model_validate(
            {
                ...
                "paid_cents": obj.get("paid_cents"),
                "received_cents": obj.get("received_cents"),
            }
        )
        return _obj
