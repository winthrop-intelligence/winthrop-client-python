...
class CoachProfile(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.instagram_handle is None and "instagram_handle" in self.model_fields_set:
        ...
        # and model_fields_set contains the field
        if self.current_school_name is None and "current_school_name" in self.model_fields_set:
            _dict['current_school_name'] = None

        # set to None if current_school_id (nullable) is None
        # and model_fields_set contains the field
        if self.current_school_id is None and "current_school_id" in self.model_fields_set:
            _dict['current_school_id'] = None

        # set to None if current_sport_name (nullable) is None
        # and model_fields_set contains the field
        if self.current_sport_name is None and "current_sport_name" in self.model_fields_set:
