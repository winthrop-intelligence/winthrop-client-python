...
class CoachProfile(BaseModel):
    ...
    visible: Optional[StrictBool] = Field(
        default=None,
        description="Whether the coach appears on customer-facing surfaces",
    )
    ...
    header_position_season_year_str: Optional[StrictStr]
    header_position_historical: StrictBool
    ...
    __properties: ClassVar[List[str]] = [
        ...
        "header_position_season_year_str",
        "header_position_historical",
        "avatar_url",
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if header_position_season_year_str (nullable) is None
        # and model_fields_set contains the field
        if (
            self.header_position_season_year_str is None
            and "header_position_season_year_str" in self.model_fields_set
        ):
            _dict["header_position_season_year_str"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "header_position_season_year_str": obj.get(
                    "header_position_season_year_str"
                ),
                "header_position_historical": obj.get("header_position_historical"),
