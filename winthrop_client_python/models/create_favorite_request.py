...
class CreateFavoriteRequest(BaseModel):
    ...
    favorites_category_id: Optional[StrictInt] = Field(default=None, description="Optional category ID. A \"Default\" category is created if omitted.")
    __properties: ClassVar[List[str]] = ["favoritable_type", "favoritable_id", "favorites_category_id"]
