...
class TeamScheduleGamePostsGamePostsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "game_post_id", "display_date", "game_types", "description", "last_rpi", "last_net_rank", "avg_rpi", "avg_net_rank", "city", "state_name", "created_at", "active", "distance", "can_manage"]
