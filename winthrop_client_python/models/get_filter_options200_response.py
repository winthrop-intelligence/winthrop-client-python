...
class GetFilterOptions200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["years", "current_year", "current_financials_year", "divisions", "sports", "position_types", "geo_regions", "gender_options", "diversity_options", "compensation_types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "divisions": [IdName.from_dict(_item) for _item in obj["divisions"]] if obj.get("divisions") is not None else None,
            "sports": [Sport.from_dict(_item) for _item in obj["sports"]] if obj.get("sports") is not None else None,
            "position_types": [FilterPositionType.from_dict(_item) for _item in obj["position_types"]] if obj.get("position_types") is not None else None,
            "geo_regions": [GeoRegion.from_dict(_item) for _item in obj["geo_regions"]] if obj.get("geo_regions") is not None else None,
