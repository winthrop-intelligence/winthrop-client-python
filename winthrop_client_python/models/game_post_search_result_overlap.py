...
class GamePostSearchResultOverlap(BaseModel):
    ...
    strong_count: StrictInt = Field(
        description="How many lined-up dates are strong (guarantee or home-and-home)."
    )
    ...
    line_ups: List[GamePostSearchResultOverlapLineUpsInner] = Field(
        description="One entry per lined-up date, strong first (guarantee, then home-and-home), then possible; ties ordered by date."
    )
