...
class CoachSearchResultCollection(BaseModel):
    """
    ...
    comp_stats: Optional[CompStats] = Field(
        default=None,
        description="Compensation statistics for the full filtered result set (before pagination). Only included when user has coach_compensation permission.",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if comp_stats (nullable) is None
        # and model_fields_set contains the field
        if self.comp_stats is None and "comp_stats" in self.model_fields_set:
            _dict["comp_stats"] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "data": (
                    [CoachSearchResult.from_dict(_item) for _item in obj["data"]]
