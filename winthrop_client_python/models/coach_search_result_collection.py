...
class CoachSearchResultCollection(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CoachSearchResult.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "meta": Meta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "comp_stats": CompStats.from_dict(obj["comp_stats"]) if obj.get("comp_stats") is not None else None
        })
        return _obj
