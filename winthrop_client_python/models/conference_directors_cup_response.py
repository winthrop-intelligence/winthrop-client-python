...
class ConferenceDirectorsCupResponse(BaseModel):
    """
    ConferenceDirectorsCupResponse
    """  # noqa: E501

    years: Optional[List[StrictInt]] = None
    schools: Optional[List[DirectorsCupSchool]] = None
    __properties: ClassVar[List[str]] = ["years", "schools"]
        ...
        _obj = cls.model_validate(
            {
                "years": obj.get("years"),
                "schools": (
                    [DirectorsCupSchool.from_dict(_item) for _item in obj["schools"]]
