...
class DepartmentOverviewPrivateCoachingPay(BaseModel):
    """
    ...
    year: StrictInt
    rows: List[DepartmentOverviewPrivateCoachingPayRow]
    __properties: ClassVar[List[str]] = ["year", "rows"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "rows": (
                    [
                        DepartmentOverviewPrivateCoachingPayRow.from_dict(_item)
