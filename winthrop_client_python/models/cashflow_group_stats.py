...
class CashflowGroupStats(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["group_id", "name_id", "name", "short_name", "report_label", "sports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sports": [CashflowSportStat.from_dict(_item) for _item in obj["sports"]] if obj.get("sports") is not None else None
        })
        return _obj
