...
class Season(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "school_id", "sport_id", "year", "wins", "losses", "conference_wins", "conference_losses", "apr", "created_at", "updated_at", "win_percent", "ties", "rpi", "prev_rpi", "conference_position", "conference_num_positions", "coach_apr", "attendance", "conference_ties", "recruit_ranking", "offensive_efficiency", "defensive_efficiency", "sos_ranking", "sos", "home_wins", "home_losses", "home_win_percent", "asr", "away_wins", "away_losses", "neutral_wins", "neutral_losses", "non_division_wins", "non_division_losses", "net_rank", "prev_net_rank", "non_conference_sos_ranking", "conference_sos_ranking", "ranking_through_date", "head_coach", "assistant_coaches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "head_coach": Coach.from_dict(obj["head_coach"]) if obj.get("head_coach") is not None else None,
            "assistant_coaches": [Coach.from_dict(_item) for _item in obj["assistant_coaches"]] if obj.get("assistant_coaches") is not None else None
        })
        return _obj
