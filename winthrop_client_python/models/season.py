...
class Season(BaseModel):
    ...
    cfp_rank: Optional[StrictInt] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if cfp_rank (nullable) is None
        # and model_fields_set contains the field
        if self.cfp_rank is None and "cfp_rank" in self.model_fields_set:
            _dict["cfp_rank"] = None
