...
class GameDetailAllOfGameContract(BaseModel):
    ...
    file_url: Optional[StrictStr] = Field(default=None, description="Only present when a raw contract file is attached")
    has_file: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "game_type", "comp_cents", "cancel_fee_cents", "signed_on", "off_site_location", "file_url", "has_file"]
