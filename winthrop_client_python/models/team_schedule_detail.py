...
class TeamScheduleDetail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["school", "sport", "season_year", "performance_year", "season", "head_coach", "non_conf_games_count", "fil_team_id", "available_years", "contacts", "games"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "school": TeamScheduleDetailSchool.from_dict(obj["school"]) if obj.get("school") is not None else None,
            "sport": TeamScheduleDetailSport.from_dict(obj["sport"]) if obj.get("sport") is not None else None,
            "season_year": obj.get("season_year"),
            "performance_year": obj.get("performance_year"),
            "season": TeamScheduleDetailSeason.from_dict(obj["season"]) if obj.get("season") is not None else None,
            "head_coach": TeamScheduleDetailHeadCoach.from_dict(obj["head_coach"]) if obj.get("head_coach") is not None else None,
            ...
            "games": [TeamScheduleDetailGame.from_dict(_item) for _item in obj["games"]] if obj.get("games") is not None else None
        })
        return _obj
