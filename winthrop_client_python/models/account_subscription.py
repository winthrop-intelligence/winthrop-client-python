...
class AccountSubscription(BaseModel):
    ...
    contract_term: Optional[StrictInt] = Field(default=None, description="Length in months (12 or 36)")
    amount_cents: Optional[StrictInt] = None
    total_price: Optional[StrictStr] = Field(default=None, description="Pre-formatted total price string")
    ...
    __properties: ClassVar[List[str]] = ["id", "subscription_type_name", "start_at", "end_at", "contract_term", "amount_cents", "total_price", "has_intercollegiate_access", "active", "autorenew", "raw_contract_id", "raw_contract_filename", "raw_contract_attached"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.subscription_type_name is None and "subscription_type_name" in self.model_fields_set:
