...
class DepartmentFinancialsLedger(BaseModel):
    """
    DepartmentFinancialsLedger
    """  # noqa: E501

    total_cents: StrictInt
    lines: List[DepartmentFinancialsLedgerLine]
    __properties: ClassVar[List[str]] = ["total_cents", "lines"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "lines": (
                    [
                        DepartmentFinancialsLedgerLine.from_dict(_item)
