...
class Scraper(BaseModel):
    ...
    argument_defs: Optional[List[ScraperArgDef]] = Field(default=None, alias="argumentDefs")
    __properties: ClassVar[List[str]] = ["name", "title", "description", "argumentDefs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "argumentDefs": [ScraperArgDef.from_dict(_item) for _item in obj["argumentDefs"]] if obj.get("argumentDefs") is not None else None
        })
        return _obj
