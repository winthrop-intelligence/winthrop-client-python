...
class WireChangeSchool(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if logo_image (nullable) is None
        # and model_fields_set contains the field
        if self.logo_image is None and "logo_image" in self.model_fields_set:
            _dict["logo_image"] = None

        # set to None if external_logo_image (nullable) is None
        # and model_fields_set contains the field
        if (
            self.external_logo_image is None
            and "external_logo_image" in self.model_fields_set
        ):
            _dict["external_logo_image"] = None
