...
class SchoolEadaFinancialsSports(BaseModel):
    """
    ...
    items: Optional[List[EadaSportResultItem]] = None
    __properties: ClassVar[List[str]] = ["found", "count", "items"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "count": obj.get("count"),
                "items": (
                    [EadaSportResultItem.from_dict(_item) for _item in obj["items"]]
