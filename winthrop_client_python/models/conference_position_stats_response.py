...
class ConferencePositionStatsResponse(BaseModel):
    """
    ConferencePositionStatsResponse
    """  # noqa: E501

    sports: Optional[List[PositionSportStat]] = None
    __properties: ClassVar[List[str]] = ["sports"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sports": (
                    [PositionSportStat.from_dict(_item) for _item in obj["sports"]]
