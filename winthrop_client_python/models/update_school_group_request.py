...
class UpdateSchoolGroupRequest(BaseModel):
    ...
    """ # noqa: E501
    school_group: UpdateSchoolGroupRequestSchoolGroup
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "school_group": UpdateSchoolGroupRequestSchoolGroup.from_dict(obj["school_group"]) if obj.get("school_group") is not None else None
        })
        return _obj
