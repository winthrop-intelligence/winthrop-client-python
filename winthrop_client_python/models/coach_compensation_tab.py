...
class CoachCompensationTab(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["can_see_compensation", "chart_data", "compensations", "total_compensations", "comparisons", "sidebar", "quartiles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chart_data": CoachCompensationTabChartData.from_dict(obj["chart_data"]) if obj.get("chart_data") is not None else None,
            ...
            "comparisons": CoachCompensationTabComparisons.from_dict(obj["comparisons"]) if obj.get("comparisons") is not None else None,
            "sidebar": CoachCompensationTabSidebar.from_dict(obj["sidebar"]) if obj.get("sidebar") is not None else None,
            "quartiles": CoachCompensationTabQuartiles.from_dict(obj["quartiles"]) if obj.get("quartiles") is not None else None
        })
        return _obj
