...
class CreateContactSearchRequest(BaseModel):
    """
    CreateContactSearchRequest
    """  # noqa: E501

    contact: Optional[CreateContactSearchRequestContact] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "contact": (
                    CreateContactSearchRequestContact.from_dict(obj["contact"])
