...
class UpdateUserRequestUser(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "email", "time_zone", "scheduling_notifications", "game_post_notifications", "games_digest", "current_password", "password", "password_confirmation"]
