...
class WireChange(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "school_id", "effective_date", "wire_type", "position_title", "article_link", "article_title", "article_description", "article_site_name", "article_publish_time", "article_image_url", "coach", "school", "position_types", "sports"]
    ...
    def wire_type_validate_enum(cls, value):
        ...
        if value not in set(['new_hire', 'promotion', 'extension', 'departed']):
            raise ValueError("must be one of enum values ('new_hire', 'promotion', 'extension', 'departed')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.article_description is None and "article_description" in self.model_fields_set:
            _dict['article_description'] = None

        # set to None if article_site_name (nullable) is None
        # and model_fields_set contains the field
        if self.article_site_name is None and "article_site_name" in self.model_fields_set:
            _dict['article_site_name'] = None

        # set to None if article_publish_time (nullable) is None
        # and model_fields_set contains the field
        if self.article_publish_time is None and "article_publish_time" in self.model_fields_set:
            _dict['article_publish_time'] = None

        # set to None if article_image_url (nullable) is None
        # and model_fields_set contains the field
        if self.article_image_url is None and "article_image_url" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "coach": WireChangeCoach.from_dict(obj["coach"]) if obj.get("coach") is not None else None,
            "school": WireChangeSchool.from_dict(obj["school"]) if obj.get("school") is not None else None,
            "position_types": [PositionType.from_dict(_item) for _item in obj["position_types"]] if obj.get("position_types") is not None else None,
            "sports": [Sport.from_dict(_item) for _item in obj["sports"]] if obj.get("sports") is not None else None
        })
        return _obj
