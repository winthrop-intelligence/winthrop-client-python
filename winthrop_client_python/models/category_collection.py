...
class CategoryCollection(BaseModel):
    ...
    data: Optional[conlist(Category)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategoryCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategoryCollection:
        """Create an instance of CategoryCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CategoryCollection.parse_obj(obj)

        _obj = CategoryCollection.parse_obj(
            {
                "data": [Category.from_dict(_item) for _item in obj.get("data")]
