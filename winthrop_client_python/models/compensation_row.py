...
class CompensationRow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "school_id", "school_name", "coach_id", "coach_name", "total_comp", "base_salary", "talent_fee", "outside_income", "contingent_bonus", "car_provided", "country_club", "buyout_terms", "contract_end"]
