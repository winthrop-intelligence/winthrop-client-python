...
class ScheduleGridSchool(BaseModel):
    ...
    rank: Optional[StrictInt] = Field(
        default=None,
        description="Latest sport-appropriate ranking shown next to the school name (NET for basketball, AP for football, RPI otherwise). Null when the school has no ranked season for the sport.",
    )
