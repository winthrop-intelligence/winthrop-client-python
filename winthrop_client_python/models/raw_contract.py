...
class RawContract(BaseModel):
    ...
    can_see_admin_view: Optional[StrictBool] = Field(default=None, description="Whether the current user can see the admin view for this contract")
    can_download: Optional[StrictBool] = Field(default=None, description="Whether the current user can download this contract's PDF")
    pdf_preview_url: Optional[StrictStr] = Field(default=None, description="Proxied URL for inline PDF viewing (no direct file access)")
    pdf_download_url: Optional[StrictStr] = Field(default=None, description="Direct download URL (admin only)")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.pdf_download_url is None and "pdf_download_url" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "back_to": RawContractBackTo.from_dict(obj["back_to"]) if obj.get("back_to") is not None else None,
            "contract_label": obj.get("contract_label"),
            "deal_info": RawContractDealInfo.from_dict(obj["deal_info"]) if obj.get("deal_info") is not None else None
        })
        return _obj
