...
class SchoolContractEntry(BaseModel):
    """
    SchoolContractEntry
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "home_school_name", "home_school_id", "away_school_name", "away_school_id", "game_type", "comp_cents", "comp_tbd", "variable", "season_year", "game_date", "game_date_tbd", "cancel_fee_cents", "cancelled", "has_raw_contract", "belongs_to_series"]
