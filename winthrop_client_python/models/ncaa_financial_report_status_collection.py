...
class NcaaFinancialReportStatusCollection(BaseModel):
    ...
    data: Optional[conlist(NcaaFinancialReportStatus)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NcaaFinancialReportStatusCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NcaaFinancialReportStatusCollection:
        """Create an instance of NcaaFinancialReportStatusCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NcaaFinancialReportStatusCollection.parse_obj(obj)

        _obj = NcaaFinancialReportStatusCollection.parse_obj(
            {
                "data": [
