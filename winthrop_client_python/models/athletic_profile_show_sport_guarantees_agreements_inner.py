...
class AthleticProfileShowSportGuaranteesAgreementsInner(BaseModel):
    """
    ...
    season_year: Optional[StrictInt] = Field(
        default=None,
        description="The season this agreement belongs to. Equal to season_year at the top level for every sport but football, whose ledger spans agreement_window.",
    )
