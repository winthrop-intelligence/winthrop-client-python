...
class ScraperApi(object):
    ...
    def list_scrapers(self, **kwargs) -> List[Scraper]:  # noqa: E501
        ...
        >>> thread = api.list_scrapers(async_req=True)
        >>> result = thread.get()
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the list_scrapers_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.list_scrapers_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def list_scrapers_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """List all available scrapers  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_scrapers_with_http_info(async_req=True)
        >>> result = thread.get()
