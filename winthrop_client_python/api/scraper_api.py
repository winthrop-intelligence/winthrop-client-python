...
class ScraperApi:
    ...
    @validate_call
    def delete_running_job(
        self,
        job_name: Annotated[StrictStr, Field(description="The Kubernetes Job name to delete")],
        ...
        :param job_name: The Kubernetes Job name to delete (required)
        :type job_name: str
        ...
        _param = self._delete_running_job_serialize(
            job_name=job_name,
    ...
    @validate_call
    def delete_running_job_with_http_info(
        self,
        job_name: Annotated[StrictStr, Field(description="The Kubernetes Job name to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_running_job_without_preload_content(
        self,
        job_name: Annotated[StrictStr, Field(description="The Kubernetes Job name to delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_running_job_serialize(
        self,
        job_name,
        _request_auth,
        _content_type,
        ...
        if job_name is not None:
            _path_params['job_name'] = job_name
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/ondemand-scrapers/jobs/{job_name}',
    ...
    def _list_jobs_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ondemand-scrapers/jobs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_scrapers(
        ...
        _param = self._list_scrapers_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_scrapers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_scrapers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_scrapers_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ondemand-scrapers/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def run_scraper(
        self,
        command: Annotated[StrictStr, Field(description="The name of the scraper to run")],
    ...
    @validate_call
    def run_scraper_without_preload_content(
        self,
        command: Annotated[StrictStr, Field(description="The name of the scraper to run")],
        body: Optional[Dict[str, Any]] = None,
        _request_timeout: Union[
    ...
    def _run_scraper_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/ondemand-scrapers/run/{command}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
