...
- API version: 0.0.0-dev.30123045613
- Package version: 0.0.0-dev.30123045613
...
*CtbApi* | [**create_ctb_compensation_processing_event**](docs/CtbApi.md#create_ctb_compensation_processing_event) | **POST** /api/v1/ctb_compensation_processing_events | 
...
*FoiaInboxApi* | [**create_foia_inbox_processing_event**](docs/FoiaInboxApi.md#create_foia_inbox_processing_event) | **POST** /api/v1/foia_inbox_processing_events | 
...
## Documentation For Models
 ...
 - [CtbCompensationProcessingEventInput](docs/CtbCompensationProcessingEventInput.md)
 - [CtbCompensationProcessingEventRequest](docs/CtbCompensationProcessingEventRequest.md)
 - [CtbCompensationProcessingEventResponse](docs/CtbCompensationProcessingEventResponse.md)
 - [CtbCompensationProcessingResult](docs/CtbCompensationProcessingResult.md)
 - [CtbGraduateAssistantCompensationProcessingEventInput](docs/CtbGraduateAssistantCompensationProcessingEventInput.md)
 - [CtbNotEmployedCompensationProcessingEventInput](docs/CtbNotEmployedCompensationProcessingEventInput.md)
 - [CtbVolunteerCompensationProcessingEventInput](docs/CtbVolunteerCompensationProcessingEventInput.md)
 - [Deal](docs/Deal.md)
 ...
 - [FoiaInboxEffectsRequestedItemsInner](docs/FoiaInboxEffectsRequestedItemsInner.md)
 ...
 - [FoiaInboxProcessingEventInput](docs/FoiaInboxProcessingEventInput.md)
 - [FoiaInboxProcessingEventInputExpectedRequest](docs/FoiaInboxProcessingEventInputExpectedRequest.md)
 - [FoiaInboxProcessingEventRequest](docs/FoiaInboxProcessingEventRequest.md)
 - [FoiaInboxProcessingEventResponse](docs/FoiaInboxProcessingEventResponse.md)
