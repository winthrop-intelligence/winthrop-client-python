...
*DossierApi* | [**university_dossier_report_dossier_winad_id_get**](docs/DossierApi.md#university_dossier_report_dossier_winad_id_get) | **GET** /api/v1/dossier/{winad_id}/ | University Dossier Report
