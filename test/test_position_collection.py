...
class TestPositionCollection(unittest.TestCase):
    """PositionCollection unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PositionCollection
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PositionCollection`
        """
        model = winthrop_client_python.models.position_collection.PositionCollection()  # noqa: E501
        if include_optional :
            return PositionCollection(
                data = [
                    winthrop_client_python.models.position.Position(
                        id = 1, 
                        season_id = 2, 
                        coach_id = 3, 
    ...
    def testPositionCollection(self):
        """Test PositionCollection"""
