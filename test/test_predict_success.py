...
class TestPredictSuccess(unittest.TestCase):
    """PredictSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PredictSuccess:
        """Test PredictSuccess
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PredictSuccess`
        """
        model = PredictSuccess()
        if include_optional:
