...
**body_html** | **str** | The CURRENT published body | 
**draft_body_html** | **str** | The compose draft, never published HTML | 
**has_html** | **bool** |  | 
**version_number** | **int** |  | 
**artifact_kinds** | **List[str]** |  | 
**artifacts** | [**List[DeskAdminArtifact]**](DeskAdminArtifact.md) |  | 
**versions** | [**List[DeskAdminVersion]**](DeskAdminVersion.md) | Newest first | 
