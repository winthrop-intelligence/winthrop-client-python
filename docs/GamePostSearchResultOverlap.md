...
**line_ups** | [**List[GamePostSearchResultOverlapLineUpsInner]**](GamePostSearchResultOverlapLineUpsInner.md) | One entry per lined-up date, strong (guarantee, home-and-home, any_format, mte, neutral_site) before possible, each tier ordered by ascending date. | 
