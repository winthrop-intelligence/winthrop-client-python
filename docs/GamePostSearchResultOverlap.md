...
**strong_count** | **int** | How many lined-up dates are strong (guarantee or home-and-home). | 
**rollup_text** | **str** | Ready-made pill summary, e.g. \&quot;3 dates line up · 2 strong\&quot;. Null when there is no overlap (total 0). | [optional] 
**line_ups** | [**List[GamePostSearchResultOverlapLineUpsInner]**](GamePostSearchResultOverlapLineUpsInner.md) | One entry per lined-up date, strong first (guarantee, then home-and-home), then possible; ties ordered by date. | 
