...
**game_types** | **List[str]** | Deal-type designations for this availability day, as the raw GameType *name* strings (e.g. \&quot;HomeAndHome\&quot;), matching posts[].game_types so the feed card resolves its deal-type chip colors. Never includes \&quot;Pending\&quot;. Typed as an array of strings rather than $ref GameType. | [optional] 
