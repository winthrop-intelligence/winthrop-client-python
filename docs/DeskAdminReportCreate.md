...
**account_id** | **int** | The audience (WINAD-10415 / D-29) — the account whose Desk this report publishes to. Absent, null or \&quot;\&quot; means EVERY school: the report lands on the Desk of every active user of every account.  | [optional] 
