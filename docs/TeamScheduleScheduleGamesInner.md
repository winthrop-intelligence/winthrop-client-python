...
**opponent_schedule_profile_eligible** | **bool** | WINAD-10097 - whether the opponent has a supported D1/D2 schedule profile; when false the name renders as text. | [optional] 
...
**compensation_direction** | **str** |  | [optional] 
