...
```python
from winthrop_client_python.models.ctb_compensation_apply_input import CtbCompensationApplyInput

# TODO update the JSON string below
json = "{}"
# create an instance of CtbCompensationApplyInput from a JSON string
ctb_compensation_apply_input_instance = CtbCompensationApplyInput.from_json(json)
# print the JSON string representation of the object
print(CtbCompensationApplyInput.to_json())

# convert the object into a dict
ctb_compensation_apply_input_dict = ctb_compensation_apply_input_instance.to_dict()
# create an instance of CtbCompensationApplyInput from a dict
ctb_compensation_apply_input_from_dict = CtbCompensationApplyInput.from_dict(ctb_compensation_apply_input_dict)
```
