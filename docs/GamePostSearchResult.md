...
**avg_rpi** | **int** | 3-year average RPI ranking (WINAD-10196 — the value non-basketball feed cards display, matching the basis the ranking filter compares against) | [optional] 
