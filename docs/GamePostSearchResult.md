...
**posts** | [**List[GamePostSearchResultPostsInner]**](GamePostSearchResultPostsInner.md) | WINAD-9909: the posting school&#39;s own active Games Wanted posts for this sport (one day per post). These are the card&#39;s date chips. The feed is grouped one row per school, so this aggregates every post for the school. | [optional] 
