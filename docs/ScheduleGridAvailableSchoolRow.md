...
**rank** | **int** | The sport&#39;s primary ranking metric (WINAD-10196) — 3-year average NET rank for basketball, 3-year average RPI for every other sport (omitted when blank) | [optional] 
