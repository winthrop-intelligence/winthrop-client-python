...
**client_note** | **str** |  | 
**clock_paused** | **bool** |  | 
**sent_to** | **List[str]** | The addresses the follow-up was queued for; empty means nothing was sent (no reachable asker, or the delivery could not be queued). The pause is applied either way.  | 
**sent_to_count** | **int** |  | 
