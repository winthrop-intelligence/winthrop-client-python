...
**home_school_net_ranking** | **int** | Latest NET ranking for the home team, or null when not loaded yet | [optional] 
**away_school_net_ranking** | **int** | Latest NET ranking for the away team, or null when not loaded yet | [optional] 
