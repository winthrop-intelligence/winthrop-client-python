...
**latest_salary** | **int** | Only included when the user has coach_compensation permission for this coach. For leader/administrator coaches, this requires administrator_compensation access. | [optional] 
**latest_salary_year** | **int** | Only included when the user has coach_compensation permission for this coach. For leader/administrator coaches, this requires administrator_compensation access. | [optional] 
