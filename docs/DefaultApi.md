...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    bulk_create_game_post_searches_request = winthrop_client_python.BulkCreateGamePostSearchesRequest() # BulkCreateGamePostSearchesRequest | 

    try:
        api_response = api_instance.bulk_create_game_post_searches(bulk_create_game_post_searches_request)
        print("The response of DefaultApi->bulk_create_game_post_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->bulk_create_game_post_searches: %s\n" % e)
```
...
back and the response identifies the failing row by its index. The
batch is capped at 500 rows; larger payloads return 422.
...
# **bulk_update_game_post_searches**
> BulkGamePostSearchResult bulk_update_game_post_searches(bulk_update_game_post_searches_request)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    bulk_update_game_post_searches_request = winthrop_client_python.BulkUpdateGamePostSearchesRequest() # BulkUpdateGamePostSearchesRequest | 

    try:
        api_response = api_instance.bulk_update_game_post_searches(bulk_update_game_post_searches_request)
        print("The response of DefaultApi->bulk_update_game_post_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->bulk_update_game_post_searches: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulk_update_game_post_searches_request** | [**BulkUpdateGamePostSearchesRequest**](BulkUpdateGamePostSearchesRequest.md)|  | 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    desk_admin_report_create = winthrop_client_python.DeskAdminReportCreate() # DeskAdminReportCreate | 

    try:
        api_response = api_instance.create_admin_desk_report(desk_admin_report_create)
        print("The response of DefaultApi->create_admin_desk_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_admin_desk_report: %s\n" % e)
```
...
Upload a download (PDF / XLSX / PPTX) to a report in any status. One row per kind —
...
```python
import winthrop_client_python
from winthrop_client_python.models.create_admin_desk_report_artifact201_response import CreateAdminDeskReportArtifact201Response
from winthrop_client_python.rest import ApiException
from pprint import pprint
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    desk_report_uuid = 'desk_report_uuid_example' # str | 
    kind = 'kind_example' # str | 
    file = None # bytearray | 

    try:
        api_response = api_instance.create_admin_desk_report_artifact(desk_report_uuid, kind, file)
        print("The response of DefaultApi->create_admin_desk_report_artifact:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_admin_desk_report_artifact: %s\n" % e)
```
...
> ContactSearchEntry create_contact_search(create_contact_search_request=create_contact_search_request)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    create_contact_search_request = winthrop_client_python.CreateContactSearchRequest() # CreateContactSearchRequest |  (optional)

    try:
        api_response = api_instance.create_contact_search(create_contact_search_request=create_contact_search_request)
        print("The response of DefaultApi->create_contact_search:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_contact_search: %s\n" % e)
```
...
Archives the report for the current user only (WINAD-10348 / D-24): upserts the
caller's desk_report_reads row and stamps archived_at. The report leaves this user's
rack and category chips and lists under `?filter=archive`; colleagues and the report
itself are unaffected, and a later republish (UPDATED) does not un-archive. Archiving
also marks the report read. Idempotent. 404 (never 403) for a foreign, draft, hidden
or unknown uuid.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    uuid = 'uuid_example' # str | Public uuid of the report

    try:
        api_response = api_instance.create_desk_report_archive(uuid)
        print("The response of DefaultApi->create_desk_report_archive:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_desk_report_archive: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **uuid** | **str**| Public uuid of the report | 
...
Records that the current user opened the report (upserts desk_report_reads).
Idempotent — the first call creates the read row, later calls bump open_count.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.create_desk_report_opened(uuid)
        print("The response of DefaultApi->create_desk_report_opened:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_desk_report_opened: %s\n" % e)
```
...
Submit an ask (03.1 guided / 03.2 pre-filled from a report CTA). The customer sends only
what they typed plus where it started; everything the DESK commits to — the working title,
its reading of the ask, the delivery date — is derived server-side into the request's
context, so the pending card, Tyler's queue and the acknowledgement email quote the same
promises. A cta_key outside the frozen §8 set, or a source report this account cannot see,
is dropped rather than refused. Creating an ask emails the requester an acknowledgement.
Requires a Desk: a caller with can_show_desk false is refused with 403
{ error: "Desk not enabled" } (WINAD-10415 / D-29).
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    create_desk_request_request = winthrop_client_python.CreateDeskRequestRequest() # CreateDeskRequestRequest | 

    try:
        api_response = api_instance.create_desk_request(create_desk_request_request)
        print("The response of DefaultApi->create_desk_request:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_desk_request: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    create_favorite_request = winthrop_client_python.CreateFavoriteRequest() # CreateFavoriteRequest | 

    try:
        api_response = api_instance.create_favorite(create_favorite_request)
        print("The response of DefaultApi->create_favorite:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_favorite: %s\n" % e)
```
...
from winthrop_client_python.models.get_favorites_categories200_response_inner import GetFavoritesCategories200ResponseInner
from winthrop_client_python.rest import ApiException
from pprint import pprint
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    create_favorites_category_request = winthrop_client_python.CreateFavoritesCategoryRequest() # CreateFavoritesCategoryRequest | 

    try:
        api_response = api_instance.create_favorites_category(create_favorites_category_request)
        print("The response of DefaultApi->create_favorites_category:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_favorites_category: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.create_game_post(create_game_post_search_request)
        print("The response of DefaultApi->create_game_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_game_post: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    create_note_request = winthrop_client_python.CreateNoteRequest() # CreateNoteRequest | 

    try:
        api_response = api_instance.create_note(create_note_request)
...
```python
import winthrop_client_python
from winthrop_client_python.models.create_password_reset200_response import CreatePasswordReset200Response
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    create_password_reset_request = winthrop_client_python.CreatePasswordResetRequest() # CreatePasswordResetRequest | 

    try:
        api_response = api_instance.create_password_reset(create_password_reset_request)
        print("The response of DefaultApi->create_password_reset:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_password_reset: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    requested_item_id = 56 # int | ID of requested item whose note should be created, replaced, or appended
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **requested_item_id** | **int**| ID of requested item whose note should be created, replaced, or appended | 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    create_school_group_request = winthrop_client_python.CreateSchoolGroupRequest() # CreateSchoolGroupRequest | 

    try:
        api_response = api_instance.create_school_group(create_school_group_request)
        print("The response of DefaultApi->create_school_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_school_group: %s\n" % e)
```
...
```python
import winthrop_client_python
from winthrop_client_python.models.create_team_schedule_favorite201_response import CreateTeamScheduleFavorite201Response
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    create_team_schedule_favorite_request = winthrop_client_python.CreateTeamScheduleFavoriteRequest() # CreateTeamScheduleFavoriteRequest | 

    try:
        api_response = api_instance.create_team_schedule_favorite(create_team_schedule_favorite_request)
        print("The response of DefaultApi->create_team_schedule_favorite:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_team_schedule_favorite: %s\n" % e)
```
...
# **create_upload**
> CreateUpload201Response create_upload(files=files)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    files = None # List[bytearray] | PDF files to upload (optional)

    try:
        api_response = api_instance.create_upload(files=files)
        print("The response of DefaultApi->create_upload:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->create_upload: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **files** | **List[bytearray]**| PDF files to upload | [optional] 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->delete_admin_desk_report_artifact: %s\n" % e)
```
...
```python
import winthrop_client_python
from winthrop_client_python.models.delete_contact_search200_response import DeleteContactSearch200Response
from winthrop_client_python.rest import ApiException
from pprint import pprint
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    id = 56 # int | ID of contact to delete

    try:
        api_response = api_instance.delete_contact_search(id)
        print("The response of DefaultApi->delete_contact_search:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->delete_contact_search: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| ID of contact to delete | 
...
Restores the report to the current user's rack — clears archived_at on their read row.
Idempotent; a report never archived answers the same 200.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_desk_report_archive(uuid)
        print("The response of DefaultApi->delete_desk_report_archive:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->delete_desk_report_archive: %s\n" % e)
```
...
```python
import winthrop_client_python
from winthrop_client_python.models.delete_favorite200_response import DeleteFavorite200Response
from winthrop_client_python.rest import ApiException
from pprint import pprint
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_favorites_category(id)
        print("The response of DefaultApi->delete_favorites_category:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->delete_favorites_category: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->delete_game_post: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    game_post_search_id = 56 # int | 

    try:
        api_response = api_instance.delete_game_post_search(game_post_search_id)
        print("The response of DefaultApi->delete_game_post_search:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->delete_game_post_search: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_note(id)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_school_group(school_group_id)
        print("The response of DefaultApi->delete_school_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->delete_school_group: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_team_schedule_favorite(id)
        print("The response of DefaultApi->delete_team_schedule_favorite:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->delete_team_schedule_favorite: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    fil_team_id = 'fil_team_id_example' # str | 

    try:
        api_instance.delete_team_schedule_note(fil_team_id)
    except Exception as e:
        print("Exception when calling DefaultApi->delete_team_schedule_note: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    upload_id = 56 # int | ID of the upload to delete

    try:
        api_response = api_instance.delete_upload(upload_id)
        print("The response of DefaultApi->delete_upload:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->delete_upload: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    confirmation_token = 'confirmation_token_example' # str | The confirmation token from the invitation email

    try:
        api_response = api_instance.get_account_user_activation(confirmation_token)
        print("The response of DefaultApi->get_account_user_activation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_account_user_activation: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_admin_desk_report(uuid)
        print("The response of DefaultApi->get_admin_desk_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_admin_desk_report: %s\n" % e)
```
...
The Desk — admin (WINAD-10312 / D-15), super-admin only. Every report on every account in
every status, newest activity first. ?status= accepts the model vocabulary
(draft/live/hidden) or the queue's (draft/published/hidden).

BOUNDED, and without bodies: list rows omit body_html, draft_body_html and versions.
This used to return every report on every account, each carrying its full published
HTML, its staged draft and every past version's HTML — a payload that grows without
limit for a screen that renders rows. The detail endpoint carries them.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    limit = 56 # int | Page size, 1–200 (default 50) (optional)
    offset = 56 # int |  (optional)

    try:
        api_response = api_instance.get_admin_desk_reports(status=status, limit=limit, offset=offset)
        print("The response of DefaultApi->get_admin_desk_reports:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_admin_desk_reports: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **status** | **str**|  | [optional] 
 **limit** | **int**| Page size, 1–200 (default 50) | [optional] 
 **offset** | **int**|  | [optional] 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    status = 'status_example' # str |  (optional)
    client = 'client_example' # str | Case-insensitive account-name substring (optional)

    try:
        api_response = api_instance.get_admin_desk_requests(status=status, client=client)
        print("The response of DefaultApi->get_admin_desk_requests:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_admin_desk_requests: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **status** | **str**|  | [optional] 
 **client** | **str**| Case-insensitive account-name substring | [optional] 
...
> AthleticProfileShow get_athletic_profile_search(athletic_profile_search_id, sport=sport, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    athletic_profile_search_id = 56 # int | School ID
    sport = 'ADMIN' # str | Sport key (defaults to ADMIN for department overview) (optional) (default to 'ADMIN')
    year = 56 # int | Performance year (optional)

    try:
        api_response = api_instance.get_athletic_profile_search(athletic_profile_search_id, sport=sport, year=year)
        print("The response of DefaultApi->get_athletic_profile_search:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_athletic_profile_search: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **athletic_profile_search_id** | **int**| School ID | 
 **sport** | **str**| Sport key (defaults to ADMIN for department overview) | [optional] [default to &#39;ADMIN&#39;]
 **year** | **int**| Performance year | [optional] 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_cashflow_groups()
        print("The response of DefaultApi->get_cashflow_groups:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_cashflow_groups: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_coach_search(id)
        print("The response of DefaultApi->get_coach_search:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_coach_search: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    id = 'id_example' # str | Coach ID or friendly slug
    school_id = 56 # int | School ID to compare cost of living against

    try:
        api_response = api_instance.get_coach_search_coli(id, school_id)
        print("The response of DefaultApi->get_coach_search_coli:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_coach_search_coli: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| Coach ID or friendly slug | 
 **school_id** | **int**| School ID to compare cost of living against | 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_coach_search_compensation(id)
        print("The response of DefaultApi->get_coach_search_compensation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_coach_search_compensation: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_coach_search_coworker_history(id)
        print("The response of DefaultApi->get_coach_search_coworker_history:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_coach_search_coworker_history: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_coach_search_overview(id)
        print("The response of DefaultApi->get_coach_search_overview:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_coach_search_overview: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_coach_search_record(id)
        print("The response of DefaultApi->get_coach_search_record:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_coach_search_record: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_coach_search_videos(id)
        print("The response of DefaultApi->get_coach_search_videos:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_coach_search_videos: %s\n" % e)
```
...
# **get_coach_searches**
> CoachSearchResultCollection get_coach_searches(page=page, per_page=per_page, q=q, position_type_id=position_type_id, contract_expires_on=contract_expires_on)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_coach_searches(page=page, per_page=per_page, q=q, position_type_id=position_type_id, contract_expires_on=contract_expires_on)
        print("The response of DefaultApi->get_coach_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_coach_searches: %s\n" % e)
```
...
> ConferenceAdminCompensationResponse get_conference_admin_compensation(conference_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_conference_admin_compensation(conference_id, year=year)
        print("The response of DefaultApi->get_conference_admin_compensation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_conference_admin_compensation: %s\n" % e)
```
...
> ConferenceCashflowStatsResponse get_conference_cashflow_stats(conference_id, group_ids=group_ids, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    conference_id = 56 # int | ID of the Conference
    group_ids = [56] # List[int] | Array of cashflow group IDs to include (optional)
    year = 56 # int | Financial year (optional)

    try:
        api_response = api_instance.get_conference_cashflow_stats(conference_id, group_ids=group_ids, year=year)
        print("The response of DefaultApi->get_conference_cashflow_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_conference_cashflow_stats: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **conference_id** | **int**| ID of the Conference | 
 **group_ids** | [**List[int]**](int.md)| Array of cashflow group IDs to include | [optional] 
...
> ConferenceDepartmentStaffResponse get_conference_department_staff(conference_id, year=year, department_id=department_id)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    conference_id = 56 # int | ID of the Conference
    year = 56 # int | Season year (optional)
    department_id = 56 # int | ID of the department PositionType to filter by (optional)

    try:
        api_response = api_instance.get_conference_department_staff(conference_id, year=year, department_id=department_id)
        print("The response of DefaultApi->get_conference_department_staff:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_conference_department_staff: %s\n" % e)
```
 ...
 **conference_id** | **int**| ID of the Conference | 
 **year** | **int**| Season year | [optional] 
 **department_id** | **int**| ID of the department PositionType to filter by | [optional] 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_conference_directors_cup(conference_id)
        print("The response of DefaultApi->get_conference_directors_cup:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_conference_directors_cup: %s\n" % e)
```
...
> ConferencePositionStatsResponse get_conference_position_stats(conference_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_conference_position_stats(conference_id, year=year)
        print("The response of DefaultApi->get_conference_position_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_conference_position_stats: %s\n" % e)
```
...
> SportCompensationResponse get_conference_sport_compensation(conference_id, sport_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_conference_sport_compensation(conference_id, sport_id, year=year)
        print("The response of DefaultApi->get_conference_sport_compensation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_conference_sport_compensation: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_contact_search_coach_options()
        print("The response of DefaultApi->get_contact_search_coach_options:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_contact_search_coach_options: %s\n" % e)
```
...
> ContactSearchCollection get_contact_searches(page=page, per_page=per_page, q=q)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_contact_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_contact_searches: %s\n" % e)
```
...
# **get_deal_searches**
> DealSearchResultCollection get_deal_searches(page=page, per_page=per_page, q=q)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_deal_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_deal_searches: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->get_department_searches: %s\n" % e)
```
...
One Desk report with its sanitized body. 404 (never 403) for a foreign, draft,
building, hidden or unknown uuid — a hidden report that points old links at a live
replacement serves the replacement instead.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_desk_report(uuid)
        print("The response of DefaultApi->get_desk_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_desk_report: %s\n" % e)
```
...
> bytearray get_desk_report_downloads_zip(uuid)

Every live download of the report in one zip archive (WINAD-10345 / D-21) — the
reader's "Everything" row. Entry names are the artifacts' own file names; the
archive is named `<report-slug>.zip` (Content-Disposition attachment). Same
resolution and authorization as GET /desk_reports/{uuid}: 404 (never 403) for a
foreign, draft, hidden or unknown uuid, the live replacement for a hidden report
that points old links at one, and 404 for a report with no downloads. The
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_desk_report_downloads_zip(uuid)
        print("The response of DefaultApi->get_desk_report_downloads_zip:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_desk_report_downloads_zip: %s\n" % e)
```
...
# **get_desk_reports**
> DeskReportsResponse get_desk_reports(filter=filter)

The Desk (WINAD-10311 / D-14) — the live reports the caller's audience reaches
(live reports published to their own account — WINAD-10415 / D-29),
newest activity first (GREATEST(published_at, current version's created_at once past v1) DESC).
Drafts, building and hidden reports are never listed. Every row carries `archived`
(the caller's own per-user archive, WINAD-10348 / D-24); `?filter=archive` lists only
the reports the caller archived, any other value lists everything.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    filter = 'filter_example' # str | `archive` — only the reports the current user archived (optional)

    try:
        api_response = api_instance.get_desk_reports(filter=filter)
        print("The response of DefaultApi->get_desk_reports:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_desk_reports: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **filter** | **str**| &#x60;archive&#x60; — only the reports the current user archived | [optional] 
...
The Desk — the current user's account's open asks (the pending ON THE DESK cards),
newest first. Delivered asks are not listed; they surface as the answering report's
request_context.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_desk_requests()
        print("The response of DefaultApi->get_desk_requests:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_desk_requests: %s\n" % e)
```
...
# **get_favorites**
> List[GetFavorites200ResponseInner] get_favorites(favoritable_type, detailed=detailed)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    detailed = 'detailed_example' # str | Pass \"1\" to include category info and favoritable name (optional)

    try:
        api_response = api_instance.get_favorites(favoritable_type, detailed=detailed)
        print("The response of DefaultApi->get_favorites:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_favorites: %s\n" % e)
```
 ...
 **detailed** | **str**| Pass \&quot;1\&quot; to include category info and favoritable name | [optional] 
...
> List[GetFavoritesCategories200ResponseInner] get_favorites_categories()
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_favorites_categories()
        print("The response of DefaultApi->get_favorites_categories:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_favorites_categories: %s\n" % e)
```
...
[**List[GetFavoritesCategories200ResponseInner]**](GetFavoritesCategories200ResponseInner.md)
...
> List[IdName] get_filter_options_all_schools()
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_filter_options_all_schools()
        print("The response of DefaultApi->get_filter_options_all_schools:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_filter_options_all_schools: %s\n" % e)
```
...
> List[IdName] get_filter_options_deal_types()
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_filter_options_deal_types()
        print("The response of DefaultApi->get_filter_options_deal_types:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_filter_options_deal_types: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_filter_options_game_types()
        print("The response of DefaultApi->get_filter_options_game_types:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_filter_options_game_types: %s\n" % e)
```
...
> List[IdName] get_filter_options_school_groups()
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_filter_options_school_groups()
        print("The response of DefaultApi->get_filter_options_school_groups:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_filter_options_school_groups: %s\n" % e)
```
...
# **get_filter_options_states**
> List[State] get_filter_options_states()
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_filter_options_states()
        print("The response of DefaultApi->get_filter_options_states:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_filter_options_states: %s\n" % e)
```
...
> List[IdName] get_filter_options_vendors(deal_type_id=deal_type_id)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    deal_type_id = 56 # int |  (optional)

    try:
        api_response = api_instance.get_filter_options_vendors(deal_type_id=deal_type_id)
        print("The response of DefaultApi->get_filter_options_vendors:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_filter_options_vendors: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_financial_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_financial_searches: %s\n" % e)
```
...
# **get_gad_searches**
> GadSearchResultCollection get_gad_searches(page=page, per_page=per_page, q=q, distance_school_type=distance_school_type, include_school_summary=include_school_summary, season_window=season_window, include_cohort_summary=include_cohort_summary, buyer_cohort=buyer_cohort, seller_cohort=seller_cohort)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    include_cohort_summary = True # bool | When true, also compute median/mean/min/max/count across the filtered cohort. Requires q[sport_id_eq]. Mutually exclusive with include_school_summary. (optional)
    buyer_cohort = 'buyer_cohort_example' # str | Restrict the buyer (home/paying) side to one NCAA cohort. Resolved server-side via Subdivision / Division taxonomy. (optional)
    seller_cohort = 'seller_cohort_example' # str | Restrict the seller (away/paid) side to one NCAA cohort. (optional)

    try:
        api_response = api_instance.get_gad_searches(page=page, per_page=per_page, q=q, distance_school_type=distance_school_type, include_school_summary=include_school_summary, season_window=season_window, include_cohort_summary=include_cohort_summary, buyer_cohort=buyer_cohort, seller_cohort=seller_cohort)
        print("The response of DefaultApi->get_gad_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_gad_searches: %s\n" % e)
```
 ...
 **include_cohort_summary** | **bool**| When true, also compute median/mean/min/max/count across the filtered cohort. Requires q[sport_id_eq]. Mutually exclusive with include_school_summary. | [optional] 
 **buyer_cohort** | **str**| Restrict the buyer (home/paying) side to one NCAA cohort. Resolved server-side via Subdivision / Division taxonomy. | [optional] 
 **seller_cohort** | **str**| Restrict the seller (away/paid) side to one NCAA cohort. | [optional] 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_game_post_search(game_post_search_id)
        print("The response of DefaultApi->get_game_post_search:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_game_post_search: %s\n" % e)
```
...
# **get_games_available_contracts**
> List[AvailableGameContract] get_games_available_contracts(sport_id=sport_id, home_school_id=home_school_id, away_school_id=away_school_id)

List GameContracts compatible with the given sport + school pair, for the
Edit Game sheet's Contract picker. Matches either direction
(home=A,away=B or home=B,away=A). Uses
`GameContract.filtered_for_game`. Capped at 50 rows, ordered by game
date descending. Rows are permission-filtered to contracts the caller's
ability can view. Requires sport_id plus at least one of
home_school_id/away_school_id — broader queries return an empty list.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    sport_id = 56 # int |  (optional)
    home_school_id = 56 # int |  (optional)
    away_school_id = 56 # int |  (optional)

    try:
        api_response = api_instance.get_games_available_contracts(sport_id=sport_id, home_school_id=home_school_id, away_school_id=away_school_id)
        print("The response of DefaultApi->get_games_available_contracts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_games_available_contracts: %s\n" % e)
```
...
[**List[AvailableGameContract]**](AvailableGameContract.md)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    notable_type = 'notable_type_example' # str | The model type (e.g. \"Coach\")
    notable_id = 56 # int | The ID of the notable record

    try:
        api_response = api_instance.get_note(notable_type, notable_id)
        print("The response of DefaultApi->get_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_note: %s\n" % e)
```
...
# **get_position_types**
> PositionTypeCollection get_position_types(page=page, per_page=per_page, q=q)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_position_types(page=page, per_page=per_page, q=q)
        print("The response of DefaultApi->get_position_types:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_position_types: %s\n" % e)
```
...
# **get_revenue_search**
> SchoolFinancialDetail get_revenue_search(revenue_search_id, school_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    revenue_search_id = 56 # int | 
    school_id = 56 # int | 
    year = 56 # int |  (optional)

    try:
        api_response = api_instance.get_revenue_search(revenue_search_id, school_id, year=year)
        print("The response of DefaultApi->get_revenue_search:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_revenue_search: %s\n" % e)
```
...
> SchoolFinancialSummary get_revenue_searches(school_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_revenue_searches(school_id, year=year)
        print("The response of DefaultApi->get_revenue_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_revenue_searches: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_schedule_grid:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_schedule_grid: %s\n" % e)
```
...
> ScheduleGridAvailableSchools get_schedule_grid_available_schools(sport_name, target_date=target_date, window_days=window_days, include_no_conflict=include_no_conflict, match_tournaments=match_tournaments, deal_types=deal_types, quality_tier=quality_tier, net_ranking_tier=net_ranking_tier, torvik_ranking_tier=torvik_ranking_tier, max_distance_miles=max_distance_miles, user_school_id=user_school_id, exclude_school_ids=exclude_school_ids)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    sport_name = 'sport_name_example' # str | Sport name (e.g. FOOTBALL, BASKETBALL_M)
    target_date = '2013-10-20' # date | Target date in ISO format (YYYY-MM-DD). Omit (blank) for an \"Any date\" market browse that ignores the window and surfaces signals across all dates. A present-but-malformed value is rejected with 400. (optional)
    window_days = 1 # int | Number of days on either side of target_date to include (default 1). Ignored in \"Any date\" mode. (optional) (default to 1)
    include_no_conflict = True # bool | When true (default), include assumed-eligible schools that have no marked conflict (no availability signal). Set false to drop them. Only meaningful in Specific-date mode. (optional) (default to True)
    ...
    try:
        api_response = api_instance.get_schedule_grid_available_schools(sport_name, target_date=target_date, window_days=window_days, include_no_conflict=include_no_conflict, match_tournaments=match_tournaments, deal_types=deal_types, quality_tier=quality_tier, net_ranking_tier=net_ranking_tier, torvik_ranking_tier=torvik_ranking_tier, max_distance_miles=max_distance_miles, user_school_id=user_school_id, exclude_school_ids=exclude_school_ids)
        print("The response of DefaultApi->get_schedule_grid_available_schools:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_schedule_grid_available_schools: %s\n" % e)
```
 ...
 **window_days** | **int**| Number of days on either side of target_date to include (default 1). Ignored in \&quot;Any date\&quot; mode. | [optional] [default to 1]
 **include_no_conflict** | **bool**| When true (default), include assumed-eligible schools that have no marked conflict (no availability signal). Set false to drop them. Only meaningful in Specific-date mode. | [optional] [default to True]
 ...
 **torvik_ranking_tier** | **str**| Restrict to a T-Rank (Bart Torvik) band, mirroring net_ranking_tier (latest non-null 3-year T-Rank average for the requested sport). Accepts a named tier (top_50, 51_100, 101_200, 201_plus) or a custom inclusive range encoded as &#x60;custom_&lt;min&gt;_&lt;max&gt;&#x60;, where either bound may be blank for an open-ended range (e.g. &#x60;custom_50_&#x60; &#x3D;&gt; 50 and up, &#x60;custom__120&#x60; &#x3D;&gt; up to 120). Schools without a T-Rank are excluded from every tier. T-Rank is basketball-only, so this filter is ignored for non-basketball sports. Unrecognized or invalid values are ignored (treated as no filter); omit the param to leave results unfiltered. | [optional] 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_schedule_grid_completed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_schedule_grid_completed: %s\n" % e)
```
...
# **get_school_department_financials**
> SchoolDepartmentFinancials get_school_department_financials(school_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    school_id = 56 # int | ID of the School
    year = 56 # int | Fiscal year; defaults to the school's latest filed year (optional)

    try:
        api_response = api_instance.get_school_department_financials(school_id, year=year)
        print("The response of DefaultApi->get_school_department_financials:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_school_department_financials: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **school_id** | **int**| ID of the School | 
 **year** | **int**| Fiscal year; defaults to the school&#39;s latest filed year | [optional] 
...
# **get_school_department_overview**
> SchoolDepartmentOverview get_school_department_overview(school_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_school_department_overview(school_id, year=year)
        print("The response of DefaultApi->get_school_department_overview:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_school_department_overview: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_school_group(school_group_id)
        print("The response of DefaultApi->get_school_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_school_group: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_school_group_cashflow_stats(school_group_id, group_ids=group_ids, year=year)
        print("The response of DefaultApi->get_school_group_cashflow_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_school_group_cashflow_stats: %s\n" % e)
```
...
> ConferencePositionStatsResponse get_school_group_position_stats(school_group_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_school_group_position_stats(school_group_id, year=year)
        print("The response of DefaultApi->get_school_group_position_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_school_group_position_stats: %s\n" % e)
```
...
> SportCompensationResponse get_school_group_sport_compensation(school_group_id, sport_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_school_group_sport_compensation(school_group_id, sport_id, year=year)
        print("The response of DefaultApi->get_school_group_sport_compensation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_school_group_sport_compensation: %s\n" % e)
```
...
# **get_school_groups**
> List[SchoolGroupShow] get_school_groups()
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_school_groups()
        print("The response of DefaultApi->get_school_groups:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_school_groups: %s\n" % e)
```
...
[**List[SchoolGroupShow]**](SchoolGroupShow.md)
...
> List[IdName] get_school_groups_available_schools()
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_school_groups_available_schools()
        print("The response of DefaultApi->get_school_groups_available_schools:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_school_groups_available_schools: %s\n" % e)
```
...
Return the total number of Division I schools. Intended for the
scheduling search surface (empty-state count on the Add School panel).
...
```python
import winthrop_client_python
from winthrop_client_python.models.get_schools_count200_response import GetSchoolsCount200Response
from winthrop_client_python.rest import ApiException
from pprint import pprint
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_schools_count()
        print("The response of DefaultApi->get_schools_count:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_schools_count: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_subdivision_cashflow_stats(subdivision_id, group_ids=group_ids, year=year)
        print("The response of DefaultApi->get_subdivision_cashflow_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_subdivision_cashflow_stats: %s\n" % e)
```
...
> ConferencePositionStatsResponse get_subdivision_position_stats(subdivision_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_subdivision_position_stats(subdivision_id, year=year)
        print("The response of DefaultApi->get_subdivision_position_stats:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_subdivision_position_stats: %s\n" % e)
```
...
> SportCompensationResponse get_subdivision_sport_compensation(subdivision_id, sport_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_subdivision_sport_compensation(subdivision_id, sport_id, year=year)
        print("The response of DefaultApi->get_subdivision_sport_compensation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_subdivision_sport_compensation: %s\n" % e)
```
...
> TeamScheduleDetail get_team_schedule_detail(sport_name, school_id, performance_year=performance_year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    sport_name = 'sport_name_example' # str | Sport name (e.g. BASKETBALL_M)
    school_id = 56 # int | School ID
    performance_year = 56 # int | Performance year to load games for (defaults to current season year) (optional)

    try:
        api_response = api_instance.get_team_schedule_detail(sport_name, school_id, performance_year=performance_year)
        print("The response of DefaultApi->get_team_schedule_detail:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_detail: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **sport_name** | **str**| Sport name (e.g. BASKETBALL_M) | 
 **school_id** | **int**| School ID | 
 **performance_year** | **int**| Performance year to load games for (defaults to current season year) | [optional] 
...
> TeamScheduleCoaches get_team_schedule_detail_coaches(sport_name, school_id, performance_year=performance_year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    sport_name = 'sport_name_example' # str | 
    school_id = 56 # int | 
    performance_year = 56 # int | Year to load coach roster for (optional)

    try:
        api_response = api_instance.get_team_schedule_detail_coaches(sport_name, school_id, performance_year=performance_year)
        print("The response of DefaultApi->get_team_schedule_detail_coaches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_detail_coaches: %s\n" % e)
```
 ...
 **sport_name** | **str**|  | 
 **school_id** | **int**|  | 
 **performance_year** | **int**| Year to load coach roster for | [optional] 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_team_schedule_detail_game_posts(sport_name, school_id)
        print("The response of DefaultApi->get_team_schedule_detail_game_posts:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_detail_game_posts: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_team_schedule_detail_player_data(sport_name, school_id)
        print("The response of DefaultApi->get_team_schedule_detail_player_data:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_detail_player_data: %s\n" % e)
```
...
> TeamScheduleSchedule get_team_schedule_detail_schedule(sport_name, school_id, year=year)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    sport_name = 'sport_name_example' # str | 
    school_id = 56 # int | 
    year = 56 # int | Season year (defaults to current schedule season year) (optional)

    try:
        api_response = api_instance.get_team_schedule_detail_schedule(sport_name, school_id, year=year)
        print("The response of DefaultApi->get_team_schedule_detail_schedule:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_detail_schedule: %s\n" % e)
```
 ...
 **sport_name** | **str**|  | 
 **school_id** | **int**|  | 
 **year** | **int**| Season year (defaults to current schedule season year) | [optional] 
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_team_schedule_detail_schedule_overlap(sport_name, school_id)
        print("The response of DefaultApi->get_team_schedule_detail_schedule_overlap:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_detail_schedule_overlap: %s\n" % e)
```
...
> List[GetTeamScheduleFavorites200ResponseInner] get_team_schedule_favorites(detailed=detailed)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    detailed = 'detailed_example' # str | When set to \"1\", includes category and favoritable name (optional)

    try:
        api_response = api_instance.get_team_schedule_favorites(detailed=detailed)
        print("The response of DefaultApi->get_team_schedule_favorites:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_favorites: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **detailed** | **str**| When set to \&quot;1\&quot;, includes category and favoritable name | [optional] 

### Return type

[**List[GetTeamScheduleFavorites200ResponseInner]**](GetTeamScheduleFavorites200ResponseInner.md)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    fil_team_id = 'fil_team_id_example' # str | FilTeam ID

    try:
        api_response = api_instance.get_team_schedule_note(fil_team_id)
        print("The response of DefaultApi->get_team_schedule_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_note: %s\n" % e)
```
...
> TeamScheduleSearchResultCollection get_team_schedule_searches(page=page, per_page=per_page, q=q, sport_name=sport_name, exclude_already_scheduled=exclude_already_scheduled, exclude_conference=exclude_conference)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_team_schedule_searches(page=page, per_page=per_page, q=q, sport_name=sport_name, exclude_already_scheduled=exclude_already_scheduled, exclude_conference=exclude_conference)
        print("The response of DefaultApi->get_team_schedule_searches:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_team_schedule_searches: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->get_upload:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_upload: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->get_upload_file: %s\n" % e)
```
...
# **get_uploads**
> UploadsResponse get_uploads(page=page)
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_uploads(page=page)
        print("The response of DefaultApi->get_uploads:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->get_uploads: %s\n" % e)
```
...
07.2 Hide from Desk — live → hidden with an internal reason; nothing is deleted. Old links
resolve to redirect_to_uuid, or (point_old_links) to the newest live report of the same
type on the account.
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    uuid = 'uuid_example' # str | Public uuid of the Desk report
    hide_admin_desk_report_request = winthrop_client_python.HideAdminDeskReportRequest() # HideAdminDeskReportRequest | 

    try:
        api_response = api_instance.hide_admin_desk_report(uuid, hide_admin_desk_report_request)
        print("The response of DefaultApi->hide_admin_desk_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->hide_admin_desk_report: %s\n" % e)
```
...
# **list_notes**
> List[ListNotes200ResponseInner] list_notes()
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of DefaultApi->list_notes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->list_notes: %s\n" % e)
```
...
[**List[ListNotes200ResponseInner]**](ListNotes200ResponseInner.md)
...
Publish a first edition with the existing JSON body, or submit an atomic Update report
patch as multipart update JSON plus downloads[pdf], downloads[xlsx] and downloads[pptx].
An update commits details, audience, cover, body, download additions/replacements/removals,
and exactly one version together. Failed validation or upload leaves the live report intact.
Omitted update fields are preserved, including legacy cover/body text; explicit body_html
must pass the report format check. A reader change_note, expected_version_number and a
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    uuid = 'uuid_example' # str | Public uuid of the Desk report
    publish_admin_desk_report_request = winthrop_client_python.PublishAdminDeskReportRequest() # PublishAdminDeskReportRequest | 

    try:
        api_response = api_instance.publish_admin_desk_report(uuid, publish_admin_desk_report_request)
        print("The response of DefaultApi->publish_admin_desk_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->publish_admin_desk_report: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.restore_admin_desk_report(uuid)
        print("The response of DefaultApi->restore_admin_desk_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->restore_admin_desk_report: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.send_otp_code()
        print("The response of DefaultApi->send_otp_code:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->send_otp_code: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    account_user_id = 56 # int | ID of the user to update
    update_account_user_request = winthrop_client_python.UpdateAccountUserRequest() # UpdateAccountUserRequest | 

    try:
        api_response = api_instance.update_account_user(account_user_id, update_account_user_request)
        print("The response of DefaultApi->update_account_user:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_account_user: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **account_user_id** | **int**| ID of the user to update | 
...
```python
import winthrop_client_python
from winthrop_client_python.models.update_account_user_activation200_response import UpdateAccountUserActivation200Response
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    update_account_user_activation_request = winthrop_client_python.UpdateAccountUserActivationRequest() # UpdateAccountUserActivationRequest | 

    try:
        api_response = api_instance.update_account_user_activation(update_account_user_activation_request)
        print("The response of DefaultApi->update_account_user_activation:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_account_user_activation: %s\n" % e)
```
...
Update the cover fields and/or the staged draft body (blank clears it). Drafts only:
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    uuid = 'uuid_example' # str | Public uuid of the Desk report
    desk_admin_report_update = winthrop_client_python.DeskAdminReportUpdate() # DeskAdminReportUpdate | 

    try:
        api_response = api_instance.update_admin_desk_report(uuid, desk_admin_report_update)
        print("The response of DefaultApi->update_admin_desk_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_admin_desk_report: %s\n" % e)
```
...
from winthrop_client_python.models.update_admin_desk_request_request import UpdateAdminDeskRequestRequest
from winthrop_client_python.rest import ApiException
from pprint import pprint
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    uuid = 'uuid_example' # str | 
    update_admin_desk_request_request = winthrop_client_python.UpdateAdminDeskRequestRequest() # UpdateAdminDeskRequestRequest | 

    try:
        api_response = api_instance.update_admin_desk_request(uuid, update_admin_desk_request_request)
        print("The response of DefaultApi->update_admin_desk_request:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_admin_desk_request: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    id = 56 # int | The favorite record ID
    update_favorite_request = winthrop_client_python.UpdateFavoriteRequest() # UpdateFavoriteRequest | 

    try:
        api_response = api_instance.update_favorite(id, update_favorite_request)
        print("The response of DefaultApi->update_favorite:\n")
        pprint(api_response)
    except Exception as e:
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    id = 56 # int | The category ID
    update_favorites_category_request = winthrop_client_python.UpdateFavoritesCategoryRequest() # UpdateFavoritesCategoryRequest | 

    try:
        api_response = api_instance.update_favorites_category(id, update_favorites_category_request)
        print("The response of DefaultApi->update_favorites_category:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_favorites_category: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    game_post_search_id = 56 # int | 
    update_game_post_search_request = winthrop_client_python.UpdateGamePostSearchRequest() # UpdateGamePostSearchRequest |  (optional)

    try:
        api_response = api_instance.update_game_post_search(game_post_search_id, update_game_post_search_request=update_game_post_search_request)
        print("The response of DefaultApi->update_game_post_search:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_game_post_search: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    id = 56 # int | 
    update_note_request = winthrop_client_python.UpdateNoteRequest() # UpdateNoteRequest | 

    try:
        api_response = api_instance.update_note(id, update_note_request)
...
```python
import winthrop_client_python
from winthrop_client_python.models.update_password_reset200_response import UpdatePasswordReset200Response
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    update_password_reset_request = winthrop_client_python.UpdatePasswordResetRequest() # UpdatePasswordResetRequest | 

    try:
        api_response = api_instance.update_password_reset(update_password_reset_request)
        print("The response of DefaultApi->update_password_reset:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_password_reset: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    school_group_id = 56 # int | ID of the School Group
    update_school_group_request = winthrop_client_python.UpdateSchoolGroupRequest() # UpdateSchoolGroupRequest | 

    try:
        api_response = api_instance.update_school_group(school_group_id, update_school_group_request)
        print("The response of DefaultApi->update_school_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_school_group: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    id = 56 # int | The favorite record ID
    update_team_schedule_favorite_request = winthrop_client_python.UpdateTeamScheduleFavoriteRequest() # UpdateTeamScheduleFavoriteRequest | 

    try:
        api_response = api_instance.update_team_schedule_favorite(id, update_team_schedule_favorite_request)
        print("The response of DefaultApi->update_team_schedule_favorite:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->update_team_schedule_favorite: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    fil_team_id = 'fil_team_id_example' # str | 
    upsert_team_schedule_note_request = winthrop_client_python.UpsertTeamScheduleNoteRequest() # UpsertTeamScheduleNoteRequest | 

    try:
        api_response = api_instance.upsert_team_schedule_note(fil_team_id, upsert_team_schedule_note_request)
        print("The response of DefaultApi->upsert_team_schedule_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->upsert_team_schedule_note: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    api_instance = winthrop_client_python.DefaultApi(api_client)
    uuid = 'uuid_example' # str | Public uuid of the Desk report
    validate_admin_desk_report_request = winthrop_client_python.ValidateAdminDeskReportRequest() # ValidateAdminDeskReportRequest | 

    try:
        api_response = api_instance.validate_admin_desk_report(uuid, validate_admin_desk_report_request)
        print("The response of DefaultApi->validate_admin_desk_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->validate_admin_desk_report: %s\n" % e)
```
...
```python
import winthrop_client_python
from winthrop_client_python.models.verify_otp_code200_response import VerifyOtpCode200Response
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = winthrop_client_python.DefaultApi(api_client)
    verify_otp_code_request = winthrop_client_python.VerifyOtpCodeRequest() # VerifyOtpCodeRequest | 

    try:
        api_response = api_instance.verify_otp_code(verify_otp_code_request)
        print("The response of DefaultApi->verify_otp_code:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->verify_otp_code: %s\n" % e)
```
...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.view_raw_contract_file(raw_contract_id)
        print("The response of DefaultApi->view_raw_contract_file:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->view_raw_contract_file: %s\n" % e)
```
