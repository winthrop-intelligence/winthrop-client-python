...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    net_ranking_tier = 'top_50' # str | Deprecated legacy name for `ranking_tier` (WINAD-10196), kept while generated clients still emit it. Same tier vocabulary and `custom_<min>_<max>` encoding. Ignored when `ranking_tier` is also present. (optional)
 ...
 **net_ranking_tier** | **str**| Deprecated legacy name for &#x60;ranking_tier&#x60; (WINAD-10196), kept while generated clients still emit it. Same tier vocabulary and &#x60;custom_&lt;min&gt;_&lt;max&gt;&#x60; encoding. Ignored when &#x60;ranking_tier&#x60; is also present. | [optional] 
