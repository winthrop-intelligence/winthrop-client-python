...
with winthrop_client_python.ApiClient(configuration) as api_client:
    ...
    per_page = 20 # int | number of results per page. (optional) (default to 20)
    q = None # object | Ransack query (optional)
    sport_name = 'sport_name_example' # str | When supplied, each returned school includes a `rank` field with its latest sport-appropriate ranking (NET/AP/RPI) for that sport. (optional)
 ...
 **per_page** | **int**| number of results per page. | [optional] [default to 20]
 **q** | [**object**](.md)| Ransack query | [optional] 
 **sport_name** | **str**| When supplied, each returned school includes a &#x60;rank&#x60; field with its latest sport-appropriate ranking (NET/AP/RPI) for that sport. | [optional] 
